extern void fillRowAddMatrix(int A[MERGE_LEVEL_MAX][MERGE_LEVEL_MAX], filter_matrix_t *mat, int m, int32_t *ind);
...
extern int minCostUsingMST(filter_matrix_t *mat, int m, int32_t *ind, double *tfill, double *tMST);
