/* This file was generated by m4 on Sun Jun 25 22:53:28 CEST 2006 */
...
#else	/* HARDCODE_PARAMS */
#define mnmat_alloc_m(x)	(x = mymalloc(mnmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define nbmat_alloc_m(x)	(x = mymalloc(nbmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define mbmat_alloc_m(x)	(x = mymalloc(mbmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define bbmat_alloc_m(x)	(x = mymalloc(bbmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define x_mnmat_alloc_m(x)	(x = mymalloc(x_mnmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define x_nbmat_alloc_m(x)	(x = mymalloc(x_nbmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define x_mbmat_alloc_m(x)	(x = mymalloc(x_mbmat_size*sizeof(mp_limb_t)))
...
#else	/* HARDCODE_PARAMS */
#define x_bbmat_alloc_m(x)	(x = mymalloc(x_bbmat_size*sizeof(mp_limb_t)))
...
#define mndft_alloc_m(s,x)	(x = mymalloc(mndft_size((s))*sizeof(mp_limb_t)))
...
#define nbdft_alloc_m(s,x)	(x = mymalloc(nbdft_size((s))*sizeof(mp_limb_t)))
...
#define mbdft_alloc_m(s,x)	(x = mymalloc(mbdft_size((s))*sizeof(mp_limb_t)))
...
#define bbdft_alloc_m(s,x)	(x = mymalloc(bbdft_size((s))*sizeof(mp_limb_t)))
