...
/* This file was generated by m4 on Sun Aug 14 17:57:35 CEST 2005 */
...
#ifdef HARDCODE_PARAMS
#define mnmat_alloc_m(x)	(x)
#define mnmat_free_m(x)
#define mnmat_head_m(x)		(&(mnmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define mnmat_alloc_m(x)	(x = my_malloc(mnmat_size*sizeof(mp_limb_t)))
#define mnmat_free_m(x)		free(x)
#define mnmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#ifdef HARDCODE_PARAMS
#define nbmat_alloc_m(x)	(x)
#define nbmat_free_m(x)
#define nbmat_head_m(x)		(&(nbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define nbmat_alloc_m(x)	(x = my_malloc(nbmat_size*sizeof(mp_limb_t)))
#define nbmat_free_m(x)		free(x)
#define nbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define ncol_alloc_m(x)	(x=(bw_ncol_r) my_malloc(ncol_size*sizeof(mp_limb_t)))
...
#ifdef HARDCODE_PARAMS
#define mbmat_alloc_m(x)	(x)
#define mbmat_free_m(x)
#define mbmat_head_m(x)		(&(mbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define mbmat_alloc_m(x)	(x = my_malloc(mbmat_size*sizeof(mp_limb_t)))
#define mbmat_free_m(x)		free(x)
#define mbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define mcol_alloc_m(x)	(x=(bw_mcol_r) my_malloc(mcol_size*sizeof(mp_limb_t)))
...
#ifdef HARDCODE_PARAMS
#define bbmat_alloc_m(x)	(x)
#define bbmat_free_m(x)
#define bbmat_head_m(x)		(&(bbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define bbmat_alloc_m(x)	(x = my_malloc(bbmat_size*sizeof(mp_limb_t)))
#define bbmat_free_m(x)		free(x)
#define bbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define bcol_alloc_m(x)	(x=(bw_bcol_r) my_malloc(bcol_size*sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define mnpoly_alloc_m(x,d)	(x=(bw_mnpoly_r) my_malloc(mnmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define nbpoly_alloc_m(x,d)	(x=(bw_nbpoly_r) my_malloc(nbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define mbpoly_alloc_m(x,d)	(x=(bw_mbpoly_r) my_malloc(mbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define bbpoly_alloc_m(x,d)	(x=(bw_bbpoly_r) my_malloc(bbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#ifdef HARDCODE_PARAMS
#define x_mnmat_alloc_m(x)	(x)
#define x_mnmat_free_m(x)
#define x_mnmat_head_m(x)		(&(x_mnmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define x_mnmat_alloc_m(x)	(x = my_malloc(x_mnmat_size*sizeof(mp_limb_t)))
#define x_mnmat_free_m(x)		free(x)
#define x_mnmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#ifdef HARDCODE_PARAMS
#define x_nbmat_alloc_m(x)	(x)
#define x_nbmat_free_m(x)
#define x_nbmat_head_m(x)		(&(x_nbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define x_nbmat_alloc_m(x)	(x = my_malloc(x_nbmat_size*sizeof(mp_limb_t)))
#define x_nbmat_free_m(x)		free(x)
#define x_nbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define x_ncol_alloc_m(x)	(x=(bw_x_ncol_r) my_malloc(x_ncol_size*sizeof(mp_limb_t)))
...
#ifdef HARDCODE_PARAMS
#define x_mbmat_alloc_m(x)	(x)
#define x_mbmat_free_m(x)
#define x_mbmat_head_m(x)		(&(x_mbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define x_mbmat_alloc_m(x)	(x = my_malloc(x_mbmat_size*sizeof(mp_limb_t)))
#define x_mbmat_free_m(x)		free(x)
#define x_mbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define x_mcol_alloc_m(x)	(x=(bw_x_mcol_r) my_malloc(x_mcol_size*sizeof(mp_limb_t)))
...
#ifdef HARDCODE_PARAMS
#define x_bbmat_alloc_m(x)	(x)
#define x_bbmat_free_m(x)
#define x_bbmat_head_m(x)		(&(x_bbmat_pos_m(x,0,0,0)))
#else	/* HARDCODE_PARAMS */
#define x_bbmat_alloc_m(x)	(x = my_malloc(x_bbmat_size*sizeof(mp_limb_t)))
#define x_bbmat_free_m(x)		free(x)
#define x_bbmat_head_m(x)		(x)
#endif	/* HARDCODE_PARAMS */
...
#define x_bcol_alloc_m(x)	(x=(bw_x_bcol_r) my_malloc(x_bcol_size*sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define x_mnpoly_alloc_m(x,d)	(x=(bw_x_mnpoly_r) my_malloc(x_mnmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define x_nbpoly_alloc_m(x,d)	(x=(bw_x_nbpoly_r) my_malloc(x_nbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define x_mbpoly_alloc_m(x,d)	(x=(bw_x_mbpoly_r) my_malloc(x_mbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define x_bbpoly_alloc_m(x,d)	(x=(bw_x_bbpoly_r) my_malloc(x_bbmat_size * ((d)+1) * sizeof(mp_limb_t)))
...
#define mndft_alloc_m(s,x)	(x = my_malloc(mndft_size((s))*sizeof(mp_limb_t)))
...
#define nbdft_alloc_m(s,x)	(x = my_malloc(nbdft_size((s))*sizeof(mp_limb_t)))
...
#define mbdft_alloc_m(s,x)	(x = my_malloc(mbdft_size((s))*sizeof(mp_limb_t)))
...
#define bbdft_alloc_m(s,x)	(x = my_malloc(bbdft_size((s))*sizeof(mp_limb_t)))
