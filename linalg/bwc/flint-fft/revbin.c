...
ulong n_revbin(ulong n, ulong b)
{
    ...
    if (b <= 8)
	return flint_revtab[n & 0xFF] >> (8 - b);
    else {
#if FLINT64
	/* swap adjacent bits */
	n = (((n & 0xaaaaaaaaaaaaaaaa) >> 1) |
	     ((n & 0x5555555555555555) << 1));

	/* swap adjacent pairs of bits */
	n = (((n & 0xcccccccccccccccc) >> 2) |
	     ((n & 0x3333333333333333) << 2));

	/* swap adjacent nibbles */
	n = (((n & 0xf0f0f0f0f0f0f0f0) >> 4) |
	     ((n & 0x0f0f0f0f0f0f0f0f) << 4));
#else
	/* swap adjacent bits */
