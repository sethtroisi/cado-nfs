...
/* *simd_p16::code_for_set_groupsize */
#define abase_p16_set_groupsize(K, n)	assert(n==1)
...
static inline
void abase_p16_field_specify(abase_p16_dst_field K, unsigned long dummy MAYBE_UNUSED, void * z)
{
    *K=*(uint16_t*) z;
}
