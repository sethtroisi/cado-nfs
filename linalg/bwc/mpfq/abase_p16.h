...
static inline
void abase_p16_add(abase_p16_dst_field, abase_p16_dst_elt, abase_p16_src_elt, abase_p16_src_elt);
static inline
void abase_p16_sub(abase_p16_dst_field, abase_p16_dst_elt, abase_p16_src_elt, abase_p16_src_elt);
static inline
void abase_p16_neg(abase_p16_dst_field, abase_p16_dst_elt, abase_p16_src_elt);
/* missing mul */
/* missing sqr */
/* missing is_sqr */
/* missing sqrt */
...
/* *Mpfq::defaults::flatdata::code_for_elt_ur_clear, simd_flat, p16 */
...
#define HAVE_abase_p16_addmul_si_ur
/* *simd_p16::code_for_addmul_si_ur */
#define abase_p16_addmul_si_ur(K, r, s1, v)	*r += *s1 * v
...
/* *Mpfq::defaults::vec::io::code_for_vec_scan, Mpfq::defaults::vec, Mpfq::defaults, p16 */
...
/* *Mpfq::defaults::flatdata::code_for_vec_elt_stride, simd_flat, p16 */
...
/* *p16::code_for_field_characteristic */
static inline
...
/* *Mpfq::defaults::flatdata::code_for_set, simd_flat, p16 */
static inline
...
/* *simd_flat::code_for_set_zero, p16 */
static inline
...
/* *p16::code_for_add */
static inline
void abase_p16_add(abase_p16_dst_field K MAYBE_UNUSED, abase_p16_dst_elt r, abase_p16_src_elt s1, abase_p16_src_elt s2)
{
    *r = *s1 + *s2; abase_p16_reduce(K, r, r);
}

/* *p16::code_for_sub */
static inline
void abase_p16_sub(abase_p16_dst_field K MAYBE_UNUSED, abase_p16_dst_elt r, abase_p16_src_elt s1, abase_p16_src_elt s2)
{
    *r = *s1 - *s2; abase_p16_reduce(K, r, r);
}
...
/* *p16::code_for_neg */
static inline
void abase_p16_neg(abase_p16_dst_field K MAYBE_UNUSED, abase_p16_dst_elt r, abase_p16_src_elt s)
{
    *r =  *r - *s;  abase_p16_reduce(K, r, r);
}

/* *Mpfq::defaults::flatdata::code_for_elt_ur_set, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::flatdata::code_for_elt_ur_set_zero, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::flatdata::code_for_cmp, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::flatdata::code_for_is_zero, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::vec::flatdata::code_for_vec_set, Mpfq::defaults::flatdata, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::vec::flatdata::code_for_vec_set_zero, Mpfq::defaults::flatdata, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_setcoef, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_getcoef, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_add, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_neg, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_rev, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_sub, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_random, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_cmp, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::flatdata::code_for_vec_is_zero, Mpfq::defaults::flatdata, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::vec::flatdata::code_for_vec_ur_set, Mpfq::defaults::flatdata, simd_flat, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_ur_setcoef, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::getset::code_for_vec_ur_getcoef, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_ur_add, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::addsub::code_for_vec_ur_sub, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
...
/* *Mpfq::defaults::vec::mul::code_for_vec_reduce, Mpfq::defaults::vec, Mpfq::defaults, p16 */
static inline
