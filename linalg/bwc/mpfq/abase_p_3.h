...
#define abase_p_3_impl_name()	"p_3"
/* *Mpfq::gfp::field::code_for_impl_max_characteristic_bits, Mpfq::gfp */
#define abase_p_3_impl_max_characteristic_bits()	192
/* *Mpfq::gfp::field::code_for_impl_max_degree, Mpfq::gfp */
#define abase_p_3_impl_max_degree()	1

/* Functions operating on the field structure */
static inline
void abase_p_3_field_characteristic(abase_p_3_dst_field, mpz_t);
static inline
unsigned long abase_p_3_field_characteristic_bits(abase_p_3_dst_field);
...
void abase_p_3_powz(abase_p_3_dst_field, abase_p_3_dst_elt, abase_p_3_src_elt, mpz_srcptr);
...
int abase_p_3_asprint(abase_p_3_dst_field, char * *, abase_p_3_src_elt);
int abase_p_3_fprint(abase_p_3_dst_field, FILE *, abase_p_3_src_elt);
...
#define abase_p_3_scan(k, x)	abase_p_3_fscan(k,stdin,x)
...
static inline
void abase_p_3_vec_setcoeff(abase_p_3_dst_field, abase_p_3_dst_vec, abase_p_3_src_elt, unsigned int);
static inline
void abase_p_3_vec_setcoeff_ui(abase_p_3_dst_field, abase_p_3_dst_vec, unsigned long, unsigned int);
static inline
void abase_p_3_vec_getcoeff(abase_p_3_dst_field, abase_p_3_dst_elt, abase_p_3_src_vec, unsigned int);
static inline
...
static inline
abase_p_3_dst_vec abase_p_3_vec_subvec(abase_p_3_dst_field, abase_p_3_dst_vec, int);
static inline
abase_p_3_src_vec abase_p_3_vec_subvec_const(abase_p_3_dst_field, abase_p_3_src_vec, int);
static inline
abase_p_3_dst_elt abase_p_3_vec_coeff_ptr(abase_p_3_dst_field, abase_p_3_dst_vec, int);
static inline
abase_p_3_src_elt abase_p_3_vec_coeff_ptr_const(abase_p_3_dst_field, abase_p_3_src_vec, int);
int abase_p_3_vec_asprint(abase_p_3_dst_field, char * *, abase_p_3_src_vec, unsigned int);
int abase_p_3_vec_fprint(abase_p_3_dst_field, FILE *, abase_p_3_src_vec, unsigned int);
int abase_p_3_vec_print(abase_p_3_dst_field, abase_p_3_src_vec, unsigned int);
...
static inline
void abase_p_3_vec_ur_setcoeff(abase_p_3_dst_field, abase_p_3_dst_vec_ur, abase_p_3_src_elt_ur, unsigned int);
static inline
void abase_p_3_vec_ur_getcoeff(abase_p_3_dst_field, abase_p_3_dst_elt_ur, abase_p_3_src_vec_ur, unsigned int);
static inline
...
static inline
abase_p_3_dst_vec_ur abase_p_3_vec_ur_subvec(abase_p_3_dst_field, abase_p_3_dst_vec_ur, int);
static inline
abase_p_3_src_vec_ur abase_p_3_vec_ur_subvec_const(abase_p_3_dst_field, abase_p_3_src_vec_ur, int);
static inline
abase_p_3_dst_elt abase_p_3_vec_ur_coeff_ptr(abase_p_3_dst_field, abase_p_3_dst_vec_ur, int);
static inline
abase_p_3_src_elt abase_p_3_vec_ur_coeff_ptr_const(abase_p_3_dst_field, abase_p_3_src_vec_ur, int);
...
#define abase_p_3_vec_ur_elt_stride(K, n)	((n)*sizeof(abase_p_3_elt_ur))
...
static inline
void abase_p_3_poly_setcoeff(abase_p_3_dst_field, abase_p_3_dst_poly, abase_p_3_src_elt, unsigned int);
static inline
void abase_p_3_poly_setcoeff_ui(abase_p_3_dst_field, abase_p_3_dst_poly, unsigned long, unsigned int);
static inline
void abase_p_3_poly_getcoeff(abase_p_3_dst_field, abase_p_3_dst_elt, abase_p_3_src_poly, unsigned int);
static inline
...
static inline
int abase_p_3_poly_asprint(abase_p_3_dst_field, char * *, abase_p_3_src_poly);
static inline
int abase_p_3_poly_fprint(abase_p_3_dst_field, FILE *, abase_p_3_src_poly);
static inline
int abase_p_3_poly_print(abase_p_3_dst_field, abase_p_3_src_poly);
static inline
...
static inline
unsigned long abase_p_3_field_characteristic_bits(abase_p_3_dst_field k)
{
...
static inline
void abase_p_3_vec_setcoeff(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec w, abase_p_3_src_elt x, unsigned int i)
{
...
static inline
void abase_p_3_vec_setcoeff_ui(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec w, unsigned long x, unsigned int i)
{
...
static inline
void abase_p_3_vec_getcoeff(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_elt x, abase_p_3_src_vec w, unsigned int i)
{
...
static inline
void abase_p_3_vec_random(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec w, unsigned int n, gmp_randstate_t state)
{
    unsigned int i;
    for(i = 0; i < n; ++i)
        abase_p_3_random(K, w[i], state);
}
...
static inline
abase_p_3_dst_vec abase_p_3_vec_subvec(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec v, int i)
{
    return v+i;
}
...
static inline
abase_p_3_src_vec abase_p_3_vec_subvec_const(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_src_vec v, int i)
{
    return v+i;
}
...
static inline
abase_p_3_dst_elt abase_p_3_vec_coeff_ptr(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec v, int i)
{
    return v[i];
}
...
static inline
abase_p_3_src_elt abase_p_3_vec_coeff_ptr_const(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_src_vec v, int i)
{
    return v[i];
}
...
static inline
void abase_p_3_vec_ur_setcoeff(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec_ur w, abase_p_3_src_elt_ur x, unsigned int i)
{
...
static inline
void abase_p_3_vec_ur_getcoeff(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_elt_ur x, abase_p_3_src_vec_ur w, unsigned int i)
{
...
static inline
abase_p_3_dst_vec_ur abase_p_3_vec_ur_subvec(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec_ur v, int i)
{
    return v+i;
}
...
static inline
abase_p_3_src_vec_ur abase_p_3_vec_ur_subvec_const(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_src_vec_ur v, int i)
{
    return v+i;
}
...
static inline
abase_p_3_dst_elt abase_p_3_vec_ur_coeff_ptr(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_dst_vec_ur v, int i)
{
    return v[i];
}
...
static inline
abase_p_3_src_elt abase_p_3_vec_ur_coeff_ptr_const(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_src_vec_ur v, int i)
{
    return v[i];
}
...
static inline
void abase_p_3_poly_setcoeff(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, abase_p_3_src_elt x, unsigned int i)
{
    if (w->alloc < (i+1)) {
    ...
    if (w->size < (i+1)) {
        abase_p_3_vec_set_zero(k, abase_p_3_vec_subvec(k, w->c, w->size), (i - w->size));
        w->size = i+1;
    }
    abase_p_3_vec_setcoeff(k, w->c, x, i);
}

/* *Mpfq::defaults::poly::code_for_poly_setcoeff_ui, Mpfq::gfp */
static inline
void abase_p_3_poly_setcoeff_ui(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, unsigned long x, unsigned int i)
{
    if (w->alloc < (i+1)) {
        abase_p_3_vec_reinit(k, &(w->c), w->alloc, i+1);
        w->alloc = i+1;
    ...
    abase_p_3_vec_setcoeff_ui(k, w->c, x, i);
}

/* *Mpfq::defaults::poly::code_for_poly_getcoeff, Mpfq::gfp */
static inline
void abase_p_3_poly_getcoeff(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_elt x, abase_p_3_src_poly w, unsigned int i)
{
    if (w->size < (i+1)) {
       abase_p_3_set_ui(k,x,0);
    } else {
       abase_p_3_vec_getcoeff(k, x, w->c, i);
    }
}
...
int abase_p_3_poly_deg(abase_p_3_dst_field K MAYBE_UNUSED, abase_p_3_src_poly w)
{
    ...
    abase_p_3_vec_getcoeff(K, temp, w->c, deg);
    int comp=abase_p_3_cmp_ui(K, temp, 0);
    while ((deg >= 0) && (comp == 0)){
        deg--;
        if (deg>=0) {
           abase_p_3_vec_getcoeff(K, temp, w->c, deg);
           comp=abase_p_3_cmp_ui(K, temp, 0);
        }
    }
...
void abase_p_3_poly_add(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, abase_p_3_src_poly u, abase_p_3_src_poly v)
{
    ...
    if (!maxsize) return;
    if (su <= sv) {
        abase_p_3_vec_add(k, w->c, u->c, v->c, su);
        abase_p_3_vec_set(k, abase_p_3_vec_subvec(k, w->c, su), abase_p_3_vec_subvec_const(k, v->c, su), sv-su);
    } else {
        abase_p_3_vec_add(k, w->c, u->c, v->c, sv);
        abase_p_3_vec_set(k, abase_p_3_vec_subvec(k, w->c, sv), abase_p_3_vec_subvec_const(k, u->c, sv), su-sv);
    }
    w->size = 1 + abase_p_3_poly_deg(k, w);
}
...
void abase_p_3_poly_sub(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, abase_p_3_src_poly u, abase_p_3_src_poly v)
{
    ...
    if (!maxsize) return;
    if (su <= sv) {
        abase_p_3_vec_sub(k, w->c, u->c, v->c, su);
        abase_p_3_vec_neg(k, abase_p_3_vec_subvec(k, w->c, su), abase_p_3_vec_subvec_const(k, v->c, su), sv-su);
    } else {
        abase_p_3_vec_sub(k, w->c, u->c, v->c, sv);
        abase_p_3_vec_set(k, abase_p_3_vec_subvec(k, w->c, sv), abase_p_3_vec_subvec_const(k, u->c, sv), su-sv);
    }
    w->size = 1 + abase_p_3_poly_deg(k, w);
}
...
void abase_p_3_poly_add_ui(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, abase_p_3_src_poly u, unsigned long x)
{
    if (u->size == 0) {
        ...
        abase_p_3_vec_setcoeff_ui(k, w->c, x, 0);
        w->size = 1;
        w->size = 1 + abase_p_3_poly_deg(k, w);
        return;
    }
    ...
    w->size=u->size;
    abase_p_3_vec_set(k, abase_p_3_vec_subvec(k, w->c, 1), abase_p_3_vec_subvec_const(k, u->c, 1), u->size - 1);
    abase_p_3_add_ui(k, abase_p_3_vec_coeff_ptr(k, w->c, 0), abase_p_3_vec_coeff_ptr_const(k, u->c, 0), x);
}
...
void abase_p_3_poly_sub_ui(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly w, abase_p_3_src_poly u, unsigned long x)
{
    if (u->size == 0) {
        ...
        abase_p_3_elt temp;
        abase_p_3_init(k, &temp);
        abase_p_3_set_ui(k, temp, x);
        abase_p_3_neg(k, abase_p_3_vec_coeff_ptr(k, w->c, 0), temp);
        w->size = abase_p_3_cmp_ui(k, temp, 0);
        abase_p_3_clear(k, &temp);
        return;
    }
    if (w->alloc < u->size) {
    ...
    w->size=u->size;
    abase_p_3_vec_set(k, abase_p_3_vec_subvec(k, w->c, 1), abase_p_3_vec_subvec_const(k, u->c, 1), u->size - 1);
    abase_p_3_sub_ui(k, abase_p_3_vec_coeff_ptr(k, w->c, 0), abase_p_3_vec_coeff_ptr_const(k, u->c, 0), x);
}
...
void abase_p_3_poly_xgcd(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_dst_poly g, abase_p_3_dst_poly u0, abase_p_3_dst_poly v0, abase_p_3_src_poly a0, abase_p_3_src_poly b0)
{
    ...
    if (db0==-1) {
     if (da0==-1) {
      ...
      abase_p_3_poly_getcoeff(k,c,a0,da0);
      abase_p_3_inv(k,c,c);
      abase_p_3_poly_scal_mul(k,g,a0,c);
      abase_p_3_poly_set(k,v0,b0);
      abase_p_3_poly_set(k,u0,b0);
      abase_p_3_poly_setcoeff(k,u0,c,0);
     }
    }
    else {
     abase_p_3_poly_init(k,a,da0+1);
     ...
     abase_p_3_poly_setcoeff_ui(k,u,1,0);
     abase_p_3_poly_setcoeff_ui(k,x,1,0);
     ...
     abase_p_3_poly_getcoeff(k,c,a,dega);
     abase_p_3_inv(k,c,c);
...
static inline
int abase_p_3_poly_asprint(abase_p_3_dst_field k MAYBE_UNUSED, char * * pstr, abase_p_3_src_poly w)
{
    return abase_p_3_vec_asprint(k, pstr, w->c, w->size);
}

/* *Mpfq::defaults::poly::code_for_poly_fprint, Mpfq::gfp */
static inline
int abase_p_3_poly_fprint(abase_p_3_dst_field k MAYBE_UNUSED, FILE * file, abase_p_3_src_poly w)
{
    return abase_p_3_vec_fprint(k, file, w->c, w->size);
}

/* *Mpfq::defaults::poly::code_for_poly_print, Mpfq::gfp */
static inline
int abase_p_3_poly_print(abase_p_3_dst_field k MAYBE_UNUSED, abase_p_3_src_poly w)
{
    return abase_p_3_vec_print(k, w->c, w->size);
}
