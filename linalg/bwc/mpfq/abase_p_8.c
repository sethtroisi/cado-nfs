...
void abase_p_8_powz(abase_p_8_dst_field k, abase_p_8_dst_elt y, abase_p_8_src_elt x, mpz_srcptr z)
{
        if (mpz_sgn(z) < 0) {
            mpz_t mz;
            mpz_init(mz);
            mpz_neg(mz, z);
            abase_p_8_powz(k, y, x, mz);
            abase_p_8_inv(k, y, y);
            mpz_clear(mz);
        } else if (mpz_sizeinbase(z, 2) > abase_p_8_field_degree(k) * abase_p_8_field_characteristic_bits(k)) {
            mpz_t zr;
            mpz_init(zr);
            mpz_t ppz;
            abase_p_8_field_characteristic(k, ppz);
            mpz_pow_ui(ppz,ppz,abase_p_8_field_degree(k));
            mpz_sub_ui(ppz,ppz,1);
            mpz_fdiv_r(zr, z, ppz);
            abase_p_8_powz(k, y, x, zr);
            mpz_clear(ppz);
            mpz_clear(zr);
        } else {
            abase_p_8_pow(k, y, x, z->_mp_d, mpz_size(z));
        }
}
...
int abase_p_8_asprint(abase_p_8_dst_field k, char * * pstr, abase_p_8_src_elt x)
{
    int i, n;
    mp_size_t size_x;
    i=8-1;
...
int abase_p_8_fprint(abase_p_8_dst_field k, FILE * file, abase_p_8_src_elt x)
{
    char *str;
    int rc;
...
int abase_p_8_vec_asprint(abase_p_8_dst_field K MAYBE_UNUSED, char * * pstr, abase_p_8_src_vec w, unsigned int n)
{
    if (n == 0) {
...
int abase_p_8_vec_fprint(abase_p_8_dst_field K MAYBE_UNUSED, FILE * file, abase_p_8_src_vec w, unsigned int n)
{
    char *str;
    int rc;
...
int abase_p_8_vec_print(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_src_vec w, unsigned int n)
{
    return abase_p_8_vec_fprint(K,stdout,w,n);
}
...
void abase_p_8_poly_setmonic(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_dst_poly q, abase_p_8_src_poly p)
{
    ...
    if (degp == 0) {
        ...
        abase_p_8_poly_setcoeff(K, q, aux, 0);
    ...
    abase_p_8_elt lc;
    abase_p_8_init(K, &lc);
    abase_p_8_poly_getcoeff(K, lc, p, degp);
    abase_p_8_inv(K, lc, lc);
    abase_p_8_poly_setcoeff_ui(K, q, 1, degp);
...
void abase_p_8_poly_divmod(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_dst_poly q, abase_p_8_dst_poly r, abase_p_8_src_poly a, abase_p_8_src_poly b)
{
    ...
    abase_p_8_poly_getcoeff(K, temp, b, degb);
    if (abase_p_8_cmp_ui(K, temp, 1) == 0) {
        abase_p_8_set_ui(K, ilb, 1);
        bmonic = 1;
    } else {
        abase_p_8_inv(K, ilb, temp);
        bmonic = 0;
    }
    ...
    for (i = dega; i >= (int)degb; --i) {
        abase_p_8_poly_getcoeff(K, aux, rr, i);
        if (!bmonic) 
            abase_p_8_mul(K, aux, aux, ilb);
        abase_p_8_poly_setcoeff(K, qq, aux, i-degb);
        for (j = i-1; j >= (int)(i - degb); --j) {
            abase_p_8_poly_getcoeff(K, temp, b, j-i+degb);
            abase_p_8_mul(K, aux2, aux, temp);
            abase_p_8_poly_getcoeff(K, temp, rr, j);
    
            abase_p_8_sub(K, temp, temp, aux2);
            abase_p_8_poly_setcoeff(K, rr, temp, j);
        }
    }    
...
void abase_p_8_poly_preinv(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_dst_poly q, abase_p_8_src_poly p, unsigned int n)
{
    ...
    abase_p_8_elt temp;
    abase_p_8_init(K, &temp);
    abase_p_8_poly_getcoeff(K, temp, p, 0);//Should be in the assert
    assert( abase_p_8_cmp_ui(K, temp, 1) == 0);
    assert (p != q);
    int m;
    if (n <= 2) {
        abase_p_8_poly_setcoeff_ui(K, q, 1, 0);
        q->size = 1;
        m = 1;
        if (n == 1)
            return;
    ...
    abase_p_8_vec_getcoeff(K, temp, tmp, 0);
    abase_p_8_add_ui(K, temp, temp, 1);
    abase_p_8_vec_setcoeff(K, tmp, temp, 0);
    abase_p_8_vec_conv(K, tmp, q->c, m, tmp, nn);
    abase_p_8_vec_set(K, abase_p_8_vec_subvec(K, q->c, m), abase_p_8_vec_subvec(K, tmp, m), n-m);
    q->size = n;
...
void abase_p_8_mpi_ops_init(abase_p_8_dst_field K MAYBE_UNUSED)
{
    ...
    MPI_Type_contiguous(abase_p_8_vec_elt_stride(K, 1), MPI_BYTE, &abase_p_8_impl_mpi_datatype);
    MPI_Type_commit(&abase_p_8_impl_mpi_datatype);
    MPI_Type_contiguous(abase_p_8_vec_ur_elt_stride(K, 1), MPI_BYTE, &abase_p_8_impl_mpi_datatype_ur);
...
static const char * abase_p_8_wrapper_impl_name();
static const char * abase_p_8_wrapper_impl_name()
{
    return abase_p_8_impl_name();
}

static unsigned long abase_p_8_wrapper_impl_max_characteristic_bits();
static unsigned long abase_p_8_wrapper_impl_max_characteristic_bits()
{
    return abase_p_8_impl_max_characteristic_bits();
}

static unsigned long abase_p_8_wrapper_impl_max_degree();
static unsigned long abase_p_8_wrapper_impl_max_degree()
{
    return abase_p_8_impl_max_degree();
}
...
static unsigned long abase_p_8_wrapper_field_characteristic_bits(abase_vbase_ptr);
static unsigned long abase_p_8_wrapper_field_characteristic_bits(abase_vbase_ptr vbase MAYBE_UNUSED)
{
    return abase_p_8_field_characteristic_bits(vbase->obj);
}
...
static void abase_p_8_wrapper_powz(abase_vbase_ptr, abase_p_8_dst_elt, abase_p_8_src_elt, mpz_srcptr);
static void abase_p_8_wrapper_powz(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_elt y MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED, mpz_srcptr z MAYBE_UNUSED)
{
    abase_p_8_powz(vbase->obj, y, x, z);
}
...
static int abase_p_8_wrapper_asprint(abase_vbase_ptr, char * *, abase_p_8_src_elt);
static int abase_p_8_wrapper_asprint(abase_vbase_ptr vbase MAYBE_UNUSED, char * * pstr MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED)
{
    return abase_p_8_asprint(vbase->obj, pstr, x);
}

static int abase_p_8_wrapper_fprint(abase_vbase_ptr, FILE *, abase_p_8_src_elt);
static int abase_p_8_wrapper_fprint(abase_vbase_ptr vbase MAYBE_UNUSED, FILE * file MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED)
{
    return abase_p_8_fprint(vbase->obj, file, x);
}

static int abase_p_8_wrapper_print(abase_vbase_ptr, abase_p_8_src_elt);
static int abase_p_8_wrapper_print(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED)
{
    return abase_p_8_print(vbase->obj, x);
}
...
static void abase_p_8_wrapper_vec_setcoeff(abase_vbase_ptr, abase_p_8_dst_vec, abase_p_8_src_elt, unsigned int);
static void abase_p_8_wrapper_vec_setcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec w MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_vec_setcoeff(vbase->obj, w, x, i);
}

static void abase_p_8_wrapper_vec_setcoeff_ui(abase_vbase_ptr, abase_p_8_dst_vec, unsigned long, unsigned int);
static void abase_p_8_wrapper_vec_setcoeff_ui(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec w MAYBE_UNUSED, unsigned long x MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_vec_setcoeff_ui(vbase->obj, w, x, i);
}

static void abase_p_8_wrapper_vec_getcoeff(abase_vbase_ptr, abase_p_8_dst_elt, abase_p_8_src_vec, unsigned int);
static void abase_p_8_wrapper_vec_getcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_elt x MAYBE_UNUSED, abase_p_8_src_vec w MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_vec_getcoeff(vbase->obj, x, w, i);
}
...
static abase_p_8_dst_vec abase_p_8_wrapper_vec_subvec(abase_vbase_ptr, abase_p_8_dst_vec, int);
static abase_p_8_dst_vec abase_p_8_wrapper_vec_subvec(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_subvec(vbase->obj, v, i);
}

static abase_p_8_src_vec abase_p_8_wrapper_vec_subvec_const(abase_vbase_ptr, abase_p_8_src_vec, int);
static abase_p_8_src_vec abase_p_8_wrapper_vec_subvec_const(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_vec v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_subvec_const(vbase->obj, v, i);
}

static abase_p_8_dst_elt abase_p_8_wrapper_vec_coeff_ptr(abase_vbase_ptr, abase_p_8_dst_vec, int);
static abase_p_8_dst_elt abase_p_8_wrapper_vec_coeff_ptr(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_coeff_ptr(vbase->obj, v, i);
}

static abase_p_8_src_elt abase_p_8_wrapper_vec_coeff_ptr_const(abase_vbase_ptr, abase_p_8_src_vec, int);
static abase_p_8_src_elt abase_p_8_wrapper_vec_coeff_ptr_const(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_vec v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_coeff_ptr_const(vbase->obj, v, i);
}

static int abase_p_8_wrapper_vec_asprint(abase_vbase_ptr, char * *, abase_p_8_src_vec, unsigned int);
static int abase_p_8_wrapper_vec_asprint(abase_vbase_ptr vbase MAYBE_UNUSED, char * * pstr MAYBE_UNUSED, abase_p_8_src_vec w MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return abase_p_8_vec_asprint(vbase->obj, pstr, w, n);
}

static int abase_p_8_wrapper_vec_fprint(abase_vbase_ptr, FILE *, abase_p_8_src_vec, unsigned int);
static int abase_p_8_wrapper_vec_fprint(abase_vbase_ptr vbase MAYBE_UNUSED, FILE * file MAYBE_UNUSED, abase_p_8_src_vec w MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return abase_p_8_vec_fprint(vbase->obj, file, w, n);
}

static int abase_p_8_wrapper_vec_print(abase_vbase_ptr, abase_p_8_src_vec, unsigned int);
static int abase_p_8_wrapper_vec_print(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_vec w MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return abase_p_8_vec_print(vbase->obj, w, n);
}
...
static void abase_p_8_wrapper_vec_ur_setcoeff(abase_vbase_ptr, abase_p_8_dst_vec_ur, abase_p_8_src_elt_ur, unsigned int);
static void abase_p_8_wrapper_vec_ur_setcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec_ur w MAYBE_UNUSED, abase_p_8_src_elt_ur x MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_vec_ur_setcoeff(vbase->obj, w, x, i);
}

static void abase_p_8_wrapper_vec_ur_getcoeff(abase_vbase_ptr, abase_p_8_dst_elt_ur, abase_p_8_src_vec_ur, unsigned int);
static void abase_p_8_wrapper_vec_ur_getcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_elt_ur x MAYBE_UNUSED, abase_p_8_src_vec_ur w MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_vec_ur_getcoeff(vbase->obj, x, w, i);
}
...
static abase_p_8_dst_vec_ur abase_p_8_wrapper_vec_ur_subvec(abase_vbase_ptr, abase_p_8_dst_vec_ur, int);
static abase_p_8_dst_vec_ur abase_p_8_wrapper_vec_ur_subvec(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec_ur v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_ur_subvec(vbase->obj, v, i);
}

static abase_p_8_src_vec_ur abase_p_8_wrapper_vec_ur_subvec_const(abase_vbase_ptr, abase_p_8_src_vec_ur, int);
static abase_p_8_src_vec_ur abase_p_8_wrapper_vec_ur_subvec_const(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_vec_ur v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_ur_subvec_const(vbase->obj, v, i);
}

static abase_p_8_dst_elt abase_p_8_wrapper_vec_ur_coeff_ptr(abase_vbase_ptr, abase_p_8_dst_vec_ur, int);
static abase_p_8_dst_elt abase_p_8_wrapper_vec_ur_coeff_ptr(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec_ur v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_ur_coeff_ptr(vbase->obj, v, i);
}

static abase_p_8_src_elt abase_p_8_wrapper_vec_ur_coeff_ptr_const(abase_vbase_ptr, abase_p_8_src_vec_ur, int);
static abase_p_8_src_elt abase_p_8_wrapper_vec_ur_coeff_ptr_const(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_vec_ur v MAYBE_UNUSED, int i MAYBE_UNUSED)
{
    return abase_p_8_vec_ur_coeff_ptr_const(vbase->obj, v, i);
}
...
static ptrdiff_t abase_p_8_wrapper_vec_ur_elt_stride(abase_vbase_ptr, int);
static ptrdiff_t abase_p_8_wrapper_vec_ur_elt_stride(abase_vbase_ptr vbase MAYBE_UNUSED, int n MAYBE_UNUSED)
{
    return abase_p_8_vec_ur_elt_stride(vbase->obj, n);
}
...
static void abase_p_8_wrapper_poly_setcoeff(abase_vbase_ptr, abase_p_8_dst_poly, abase_p_8_src_elt, unsigned int);
static void abase_p_8_wrapper_poly_setcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_poly w MAYBE_UNUSED, abase_p_8_src_elt x MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_poly_setcoeff(vbase->obj, w, x, i);
}

static void abase_p_8_wrapper_poly_setcoeff_ui(abase_vbase_ptr, abase_p_8_dst_poly, unsigned long, unsigned int);
static void abase_p_8_wrapper_poly_setcoeff_ui(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_poly w MAYBE_UNUSED, unsigned long x MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_poly_setcoeff_ui(vbase->obj, w, x, i);
}

static void abase_p_8_wrapper_poly_getcoeff(abase_vbase_ptr, abase_p_8_dst_elt, abase_p_8_src_poly, unsigned int);
static void abase_p_8_wrapper_poly_getcoeff(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_elt x MAYBE_UNUSED, abase_p_8_src_poly w MAYBE_UNUSED, unsigned int i MAYBE_UNUSED)
{
    abase_p_8_poly_getcoeff(vbase->obj, x, w, i);
}
...
static int abase_p_8_wrapper_poly_asprint(abase_vbase_ptr, char * *, abase_p_8_src_poly);
static int abase_p_8_wrapper_poly_asprint(abase_vbase_ptr vbase MAYBE_UNUSED, char * * pstr MAYBE_UNUSED, abase_p_8_src_poly w MAYBE_UNUSED)
{
    return abase_p_8_poly_asprint(vbase->obj, pstr, w);
}

static int abase_p_8_wrapper_poly_fprint(abase_vbase_ptr, FILE *, abase_p_8_src_poly);
static int abase_p_8_wrapper_poly_fprint(abase_vbase_ptr vbase MAYBE_UNUSED, FILE * file MAYBE_UNUSED, abase_p_8_src_poly w MAYBE_UNUSED)
{
    return abase_p_8_poly_fprint(vbase->obj, file, w);
}

static int abase_p_8_wrapper_poly_print(abase_vbase_ptr, abase_p_8_src_poly);
static int abase_p_8_wrapper_poly_print(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_src_poly w MAYBE_UNUSED)
{
    return abase_p_8_poly_print(vbase->obj, w);
}
...
void abase_p_8_oo_field_init(abase_vbase_ptr vbase)
{
    ...
    vbase->impl_name = (const char * (*) ()) abase_p_8_wrapper_impl_name;
    vbase->impl_max_characteristic_bits = (unsigned long (*) ()) abase_p_8_wrapper_impl_max_characteristic_bits;
    vbase->impl_max_degree = (unsigned long (*) ()) abase_p_8_wrapper_impl_max_degree;
    vbase->field_characteristic = (void (*) (abase_vbase_ptr, mpz_t)) abase_p_8_wrapper_field_characteristic;
    vbase->field_characteristic_bits = (unsigned long (*) (abase_vbase_ptr)) abase_p_8_wrapper_field_characteristic_bits;
    ...
    vbase->powz = (void (*) (abase_vbase_ptr, void *, const void *, mpz_srcptr)) abase_p_8_wrapper_powz;
    ...
    vbase->asprint = (int (*) (abase_vbase_ptr, char * *, const void *)) abase_p_8_wrapper_asprint;
    vbase->fprint = (int (*) (abase_vbase_ptr, FILE *, const void *)) abase_p_8_wrapper_fprint;
    vbase->print = (int (*) (abase_vbase_ptr, const void *)) abase_p_8_wrapper_print;
    ...
    vbase->vec_setcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_vec_setcoeff;
    vbase->vec_setcoeff_ui = (void (*) (abase_vbase_ptr, void *, unsigned long, unsigned int)) abase_p_8_wrapper_vec_setcoeff_ui;
    vbase->vec_getcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_vec_getcoeff;
    ...
    vbase->vec_subvec = (void * (*) (abase_vbase_ptr, void *, int)) abase_p_8_wrapper_vec_subvec;
    vbase->vec_subvec_const = (const void * (*) (abase_vbase_ptr, const void *, int)) abase_p_8_wrapper_vec_subvec_const;
    vbase->vec_coeff_ptr = (void * (*) (abase_vbase_ptr, void *, int)) abase_p_8_wrapper_vec_coeff_ptr;
    vbase->vec_coeff_ptr_const = (const void * (*) (abase_vbase_ptr, const void *, int)) abase_p_8_wrapper_vec_coeff_ptr_const;
    vbase->vec_asprint = (int (*) (abase_vbase_ptr, char * *, const void *, unsigned int)) abase_p_8_wrapper_vec_asprint;
    vbase->vec_fprint = (int (*) (abase_vbase_ptr, FILE *, const void *, unsigned int)) abase_p_8_wrapper_vec_fprint;
    vbase->vec_print = (int (*) (abase_vbase_ptr, const void *, unsigned int)) abase_p_8_wrapper_vec_print;
    ...
    vbase->vec_ur_setcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_vec_ur_setcoeff;
    vbase->vec_ur_getcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_vec_ur_getcoeff;
    ...
    vbase->vec_ur_subvec = (void * (*) (abase_vbase_ptr, void *, int)) abase_p_8_wrapper_vec_ur_subvec;
    vbase->vec_ur_subvec_const = (const void * (*) (abase_vbase_ptr, const void *, int)) abase_p_8_wrapper_vec_ur_subvec_const;
    vbase->vec_ur_coeff_ptr = (void * (*) (abase_vbase_ptr, void *, int)) abase_p_8_wrapper_vec_ur_coeff_ptr;
    vbase->vec_ur_coeff_ptr_const = (const void * (*) (abase_vbase_ptr, const void *, int)) abase_p_8_wrapper_vec_ur_coeff_ptr_const;
    vbase->vec_elt_stride = (ptrdiff_t (*) (abase_vbase_ptr, int)) abase_p_8_wrapper_vec_elt_stride;
    vbase->vec_ur_elt_stride = (ptrdiff_t (*) (abase_vbase_ptr, int)) abase_p_8_wrapper_vec_ur_elt_stride;
    ...
    vbase->poly_setcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_poly_setcoeff;
    vbase->poly_setcoeff_ui = (void (*) (abase_vbase_ptr, void *, unsigned long, unsigned int)) abase_p_8_wrapper_poly_setcoeff_ui;
    vbase->poly_getcoeff = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_p_8_wrapper_poly_getcoeff;
    ...
    vbase->poly_asprint = (int (*) (abase_vbase_ptr, char * *, const void *)) abase_p_8_wrapper_poly_asprint;
    vbase->poly_fprint = (int (*) (abase_vbase_ptr, FILE *, const void *)) abase_p_8_wrapper_poly_fprint;
    vbase->poly_print = (int (*) (abase_vbase_ptr, const void *)) abase_p_8_wrapper_poly_print;
