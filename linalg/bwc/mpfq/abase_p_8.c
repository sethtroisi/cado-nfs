...
{
        if (k->p == NULL) k->p = (mp_limb_t *)mpfq_malloc_check(8*sizeof(mp_limb_t));
        if (k->bigmul_p == NULL) k->bigmul_p = (mp_limb_t *)mpfq_malloc_check(17*sizeof(mp_limb_t));
        k->kl = 8;
        k->url = 17;
...
void abase_p_8_poly_divmod(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_dst_poly q, abase_p_8_dst_poly r, abase_p_8_src_poly a, abase_p_8_src_poly b)
{
    ...
    abase_p_8_poly_getcoef(K, temp, b, degb);
    ...
    for (i = dega; i >= (int)degb; --i) {
        ...
        for (j = i-1; j >= (int)(i - degb); --j) {
            abase_p_8_poly_getcoef(K, temp, b, j-i+degb);
            abase_p_8_mul(K, aux2, aux, temp);
            abase_p_8_poly_getcoef(K, temp, rr, j);
    
            abase_p_8_sub(K, temp, temp, aux2);
            abase_p_8_poly_setcoef(K, rr, temp, j);
        }
    }    
...
void abase_p_8_poly_preinv(abase_p_8_dst_field K MAYBE_UNUSED, abase_p_8_dst_poly q, abase_p_8_src_poly p, unsigned int n)
{
    ...
    abase_p_8_elt temp;
    abase_p_8_init(K, &temp);
    abase_p_8_poly_getcoef(K, temp, p, 0);//Should be in the assert
    ...
    abase_p_8_vec_getcoef(K, temp, tmp, 0);
    abase_p_8_add_ui(K, temp, temp, 1);
    abase_p_8_vec_setcoef(K, tmp, temp, 0);
...
static void abase_p_8_wrapper_vec_set_partial(abase_vbase_ptr, abase_p_8_dst_vec, abase_p_8_src_vec, unsigned int, unsigned int, unsigned int);
static void abase_p_8_wrapper_vec_set_partial(abase_vbase_ptr vbase MAYBE_UNUSED, abase_p_8_dst_vec w MAYBE_UNUSED, abase_p_8_src_vec u MAYBE_UNUSED, unsigned int bw MAYBE_UNUSED, unsigned int bu MAYBE_UNUSED, unsigned int l MAYBE_UNUSED)
{
    abase_p_8_vec_set_partial(vbase->obj, w, u, bw, bu, l);
}
...
void abase_p_8_oo_field_init(abase_vbase_ptr vbase)
{
    ...
    vbase->vec_set_partial = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int, unsigned int, unsigned int)) abase_p_8_wrapper_vec_set_partial;
