...
static void abase_u64k1_wrapper_vec_set_partial(abase_vbase_ptr, abase_u64k1_dst_vec, abase_u64k1_src_vec, unsigned int, unsigned int, unsigned int);
static void abase_u64k1_wrapper_vec_set_partial(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k1_dst_vec w MAYBE_UNUSED, abase_u64k1_src_vec u MAYBE_UNUSED, unsigned int bw MAYBE_UNUSED, unsigned int bu MAYBE_UNUSED, unsigned int l MAYBE_UNUSED)
{
    abase_u64k1_vec_set_partial(vbase->obj, w, u, bw, bu, l);
}
...
void abase_u64k1_oo_field_init(abase_vbase_ptr vbase)
{
    ...
    vbase->vec_set_partial = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int, unsigned int, unsigned int)) abase_u64k1_wrapper_vec_set_partial;
