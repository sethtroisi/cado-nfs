...
void abase_u64k2_mpi_ops_init(abase_u64k2_dst_field K MAYBE_UNUSED)
{
    ...
    MPI_Type_contiguous(abase_u64k2_vec_elt_stride(K, 1), MPI_BYTE, &abase_u64k2_impl_mpi_datatype);
    MPI_Type_commit(&abase_u64k2_impl_mpi_datatype);
    MPI_Type_contiguous(abase_u64k2_vec_ur_elt_stride(K, 1), MPI_BYTE, &abase_u64k2_impl_mpi_datatype_ur);
...
static const char * abase_u64k2_wrapper_impl_name();
static const char * abase_u64k2_wrapper_impl_name()
{
    return abase_u64k2_impl_name();
}
...
static void abase_u64k2_wrapper_random(abase_vbase_ptr, abase_u64k2_dst_elt, gmp_randstate_t);
static void abase_u64k2_wrapper_random(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k2_dst_elt r MAYBE_UNUSED, gmp_randstate_t state MAYBE_UNUSED)
{
    abase_u64k2_random(vbase->obj, r, state);
}
...
static void abase_u64k2_wrapper_elt_ur_set_elt(abase_vbase_ptr, abase_u64k2_dst_elt_ur, abase_u64k2_src_elt);
static void abase_u64k2_wrapper_elt_ur_set_elt(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k2_dst_elt_ur r MAYBE_UNUSED, abase_u64k2_src_elt s MAYBE_UNUSED)
{
    abase_u64k2_elt_ur_set_elt(vbase->obj, r, s);
}
...
static void abase_u64k2_wrapper_vec_random(abase_vbase_ptr, abase_u64k2_dst_vec, unsigned int, gmp_randstate_t);
static void abase_u64k2_wrapper_vec_random(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k2_dst_vec w MAYBE_UNUSED, unsigned int n MAYBE_UNUSED, gmp_randstate_t state MAYBE_UNUSED)
{
    abase_u64k2_vec_random(vbase->obj, w, n, state);
}
...
static void abase_u64k2_wrapper_vec_ur_set_vec(abase_vbase_ptr, abase_u64k2_dst_vec_ur, abase_u64k2_src_vec, unsigned int);
static void abase_u64k2_wrapper_vec_ur_set_vec(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k2_dst_vec_ur w MAYBE_UNUSED, abase_u64k2_src_vec u MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    abase_u64k2_vec_ur_set_vec(vbase->obj, w, u, n);
}
...
static void abase_u64k2_wrapper_vec_ur_neg(abase_vbase_ptr, abase_u64k2_dst_vec_ur, abase_u64k2_src_vec_ur, unsigned int);
static void abase_u64k2_wrapper_vec_ur_neg(abase_vbase_ptr vbase MAYBE_UNUSED, abase_u64k2_dst_vec_ur w MAYBE_UNUSED, abase_u64k2_src_vec_ur u MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    abase_u64k2_vec_ur_neg(vbase->obj, w, u, n);
}

static void abase_u64k2_wrapper_vec_ur_rev(abase_vbase_ptr, abase_u64k2_dst_vec_ur, abase_u64k2_src_vec_ur, unsigned int);
...
static ptrdiff_t abase_u64k2_wrapper_vec_ur_elt_stride(abase_vbase_ptr, int);
static ptrdiff_t abase_u64k2_wrapper_vec_ur_elt_stride(abase_vbase_ptr vbase MAYBE_UNUSED, int n MAYBE_UNUSED)
{
    return abase_u64k2_vec_ur_elt_stride(vbase->obj, n);
}
...
void abase_u64k2_oo_field_init(abase_vbase_ptr vbase)
{
    ...
    vbase->impl_name = (const char * (*) ()) abase_u64k2_wrapper_impl_name;
    /* missing impl_max_characteristic_bits */
    /* missing impl_max_degree */
    ...
    /* missing get_mpn */
    /* missing get_mpz */
    vbase->random = (void (*) (abase_vbase_ptr, void *, gmp_randstate_t)) abase_u64k2_wrapper_random;
    /* missing random2 */
    ...
    vbase->elt_ur_set_elt = (void (*) (abase_vbase_ptr, void *, const void *)) abase_u64k2_wrapper_elt_ur_set_elt;
    ...
    /* missing vec_scal_mul */
    /* missing vec_conv */
    vbase->vec_random = (void (*) (abase_vbase_ptr, void *, unsigned int, gmp_randstate_t)) abase_u64k2_wrapper_vec_random;
    /* missing vec_random2 */
    ...
    vbase->vec_ur_set_vec = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_u64k2_wrapper_vec_ur_set_vec;
    ...
    vbase->vec_ur_rev = (void (*) (abase_vbase_ptr, void *, const void *, unsigned int)) abase_u64k2_wrapper_vec_ur_rev;
    /* missing vec_scal_mul_ur */
    /* missing vec_conv_ur */
    /* missing vec_reduce */
    ...
    vbase->vec_ur_elt_stride = (ptrdiff_t (*) (abase_vbase_ptr, int)) abase_u64k2_wrapper_vec_ur_elt_stride;
    /* missing poly_init */
    /* missing poly_clear */
    /* missing poly_set */
    /* missing poly_setmonic */
