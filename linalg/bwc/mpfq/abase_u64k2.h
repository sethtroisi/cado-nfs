...
static inline
void abase_u64k2_vec_set_partial(abase_u64k2_dst_field, abase_u64k2_dst_vec, abase_u64k2_src_vec, unsigned int, unsigned int, unsigned int);
static inline
...
static inline
void abase_u64k2_vec_set_partial(abase_u64k2_dst_field k MAYBE_UNUSED, abase_u64k2_dst_vec w, abase_u64k2_src_vec u, unsigned int bw, unsigned int bu, unsigned int l)
{
    unsigned int i;
    for(i = 0; i < l; ++i)
        abase_u64k2_set(k, w[bw+i], u[bu+i]);
}
