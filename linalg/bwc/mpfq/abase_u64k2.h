...
/* Options used: k=2 tag=u64k2 choose_by_groupsize=CODE(0x2820cf8) prefix=abase_ family=[u64k1, u64k2] virtual_base={
...
#define abase_u64k2_set_groupsize(K, n)	assert(n==128)
