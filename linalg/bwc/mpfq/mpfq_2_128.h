...
void mpfq_2_128_powz(mpfq_2_128_dst_field, mpfq_2_128_dst_elt, mpfq_2_128_src_elt, mpz_srcptr);
...
#define mpfq_2_128_scan(k, x)	mpfq_2_128_fscan(k,stdin,x)
...
#define SET(lo, hi) _mm_set_epi64(_m_from_int64((hi)), _m_from_int64((lo)))
#define SET1(lo) _mm_set1_epi64(_m_from_int64((lo)))
    __m128i u;
    __m128i t0;
    __m128i t1;
    __m128i t2;
    ...
    __m128i w;
    __m128i v1, v2;
    __m128i m = SET1(0xeeeeeeeeeeeeeeeeUL);
    /* sequence update walk */
    g[ 0] = _mm_setzero_si128();
    __m128i b0 = SET(s2[0], s2[1]);
    g[ 1] = b0;
    v1 = SET1(s1[0]);
    w = _mm_sub_epi64(_mm_setzero_si128(), SHR(b0,63));
    v2 = SET1(s1[1]);
    v1 = SHR(_mm_and_si128(v1, m), 1);
    t1 = _mm_and_si128(v1, w);
    g[ 2] = SHL(b0, 1); g[ 3] = _mm_xor_si128(g[ 2], b0);
    v2 = SHR(_mm_and_si128(v2, m), 1);
    t2 = _mm_and_si128(v2, w);
    g[ 4] = SHL(g[ 2], 1); g[ 5] = _mm_xor_si128(g[ 4], b0);
    w = _mm_sub_epi64(_mm_setzero_si128(), SHR(g[ 2],63));
    g[ 6] = SHL(g[ 3], 1); g[ 7] = _mm_xor_si128(g[ 6], b0);
    v1 = SHR(_mm_and_si128(v1, m), 1);
    t1 = _mm_xor_si128(t1, _mm_and_si128(v1, w));
    g[ 8] = SHL(g[ 4], 1); g[ 9] = _mm_xor_si128(g[ 8], b0);
    v2 = SHR(_mm_and_si128(v2, m), 1);
    t2 = _mm_xor_si128(t2, _mm_and_si128(v2, w));
    g[10] = SHL(g[ 5], 1); g[11] = _mm_xor_si128(g[10], b0);
    w = _mm_sub_epi64(_mm_setzero_si128(), SHR(g[4],63));
    g[12] = SHL(g[ 6], 1); g[13] = _mm_xor_si128(g[12], b0);
    v1 = SHR(_mm_and_si128(v1, m), 1);
    t1 = _mm_xor_si128(t1, _mm_and_si128(v1, w));
    g[14] = SHL(g[ 7], 1); g[15] = _mm_xor_si128(g[14], b0);
    v2 = SHR(_mm_and_si128(v2, m), 1);
    t2 = _mm_xor_si128(t2, _mm_and_si128(v2, w));
    ...
    /* round 0 */
    u = g[s1[0]       & 15]; t0  = u;
    u = g[s1[0] >>  4 & 15]; t0 = _mm_xor_si128(t0, SHL(u,  4)); t1 = _mm_xor_si128(t1, SHR(u, 60));
    u = g[s1[0] >>  8 & 15]; t0 = _mm_xor_si128(t0, SHL(u,  8)); t1 = _mm_xor_si128(t1, SHR(u, 56));
    u = g[s1[0] >> 12 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 12)); t1 = _mm_xor_si128(t1, SHR(u, 52));
    u = g[s1[0] >> 16 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 16)); t1 = _mm_xor_si128(t1, SHR(u, 48));
    u = g[s1[0] >> 20 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 20)); t1 = _mm_xor_si128(t1, SHR(u, 44));
    u = g[s1[0] >> 24 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 24)); t1 = _mm_xor_si128(t1, SHR(u, 40));
    u = g[s1[0] >> 28 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 28)); t1 = _mm_xor_si128(t1, SHR(u, 36));
    u = g[s1[0] >> 32 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 32)); t1 = _mm_xor_si128(t1, SHR(u, 32));
    u = g[s1[0] >> 36 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 36)); t1 = _mm_xor_si128(t1, SHR(u, 28));
    u = g[s1[0] >> 40 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 40)); t1 = _mm_xor_si128(t1, SHR(u, 24));
    u = g[s1[0] >> 44 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 44)); t1 = _mm_xor_si128(t1, SHR(u, 20));
    u = g[s1[0] >> 48 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 48)); t1 = _mm_xor_si128(t1, SHR(u, 16));
    u = g[s1[0] >> 52 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 52)); t1 = _mm_xor_si128(t1, SHR(u, 12));
    u = g[s1[0] >> 56 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 56)); t1 = _mm_xor_si128(t1, SHR(u,  8));
    u = g[s1[0] >> 60 & 15]; t0 = _mm_xor_si128(t0, SHL(u, 60)); t1 = _mm_xor_si128(t1, SHR(u,  4));
    
    /* round 1 */
    u = g[s1[1]       & 15]; t1 = _mm_xor_si128(t1, u);
    u = g[s1[1] >>  4 & 15]; t1 = _mm_xor_si128(t1, SHL(u,  4)); t2 = _mm_xor_si128(t2, SHR(u, 60));
    u = g[s1[1] >>  8 & 15]; t1 = _mm_xor_si128(t1, SHL(u,  8)); t2 = _mm_xor_si128(t2, SHR(u, 56));
    u = g[s1[1] >> 12 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 12)); t2 = _mm_xor_si128(t2, SHR(u, 52));
    u = g[s1[1] >> 16 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 16)); t2 = _mm_xor_si128(t2, SHR(u, 48));
    u = g[s1[1] >> 20 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 20)); t2 = _mm_xor_si128(t2, SHR(u, 44));
    u = g[s1[1] >> 24 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 24)); t2 = _mm_xor_si128(t2, SHR(u, 40));
    u = g[s1[1] >> 28 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 28)); t2 = _mm_xor_si128(t2, SHR(u, 36));
    u = g[s1[1] >> 32 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 32)); t2 = _mm_xor_si128(t2, SHR(u, 32));
    u = g[s1[1] >> 36 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 36)); t2 = _mm_xor_si128(t2, SHR(u, 28));
    u = g[s1[1] >> 40 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 40)); t2 = _mm_xor_si128(t2, SHR(u, 24));
    u = g[s1[1] >> 44 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 44)); t2 = _mm_xor_si128(t2, SHR(u, 20));
    u = g[s1[1] >> 48 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 48)); t2 = _mm_xor_si128(t2, SHR(u, 16));
    u = g[s1[1] >> 52 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 52)); t2 = _mm_xor_si128(t2, SHR(u, 12));
    u = g[s1[1] >> 56 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 56)); t2 = _mm_xor_si128(t2, SHR(u,  8));
    u = g[s1[1] >> 60 & 15]; t1 = _mm_xor_si128(t1, SHL(u, 60)); t2 = _mm_xor_si128(t2, SHR(u,  4));
    /* end */
            /* store result */
            t0 = _mm_xor_si128(t0, SHLD(t1, 64));
            t2 = _mm_xor_si128(t2, SHRD(t1, 64));
            _mm_storeu_si128((__m128i *) t,     t0);
            _mm_storeu_si128((__m128i *) (t+2), t2);
#undef SET1
#undef SET
#undef SHL
#undef SHR
