...
void mpfq_p_11_p_11_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_p_11_dst_vec xw, mpfq_p_11_src_vec xu1, mpfq_p_11_src_vec xu0, unsigned int n)
{
    mpfq_p_11_p_11_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_11 */

#ifdef COMPILE_MPFQ_PRIME_FIELD_p_11
/* *simd_gfp::code_for_member_template_add_dotprod */
void mpfq_p_11_p_11_add_dotprod(mpfq_p_11_dst_field K0 MAYBE_UNUSED, mpfq_p_11_dst_field K1 MAYBE_UNUSED, mpfq_p_11_dst_vec xw, mpfq_p_11_src_vec xu1, mpfq_p_11_src_vec xu0, unsigned int n)
{
        mpfq_p_11_elt_ur s,t;
        mpfq_p_11_elt_ur_init(K0, &s);
        mpfq_p_11_elt_ur_init(K0, &t);
        mpfq_p_11_elt_ur_set_elt(K0, s, xw[0]);
        for(unsigned int i = 0 ; i < n ; i++) {
            mpfq_p_11_mul_ur(K0, t, xu0[i], xu1[i]);
            mpfq_p_11_elt_ur_add(K0, s, s, t);
        }
        mpfq_p_11_reduce(K0, xw[0], s);
        mpfq_p_11_elt_ur_clear(K0, &s);
