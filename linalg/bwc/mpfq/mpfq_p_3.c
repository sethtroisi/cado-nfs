...
static void mpfq_p_3_init_ts(mpfq_p_3_dst_field k)
{
    ...
    if (e-1 < 64) {
        ...
        mpfq_fixmp_3_long_lshift(s, (e-1)/64, (e-1)%64);
    }
    k->ts_info.e = e;
...
void mpfq_p_3_vec_random(mpfq_p_3_dst_field k, mpfq_p_3_dst_vec w, unsigned int n, gmp_randstate_t state)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_dst_elt x = mpfq_p_3_vec_coeff_ptr(k, w, i);
        mpfq_p_3_random(k, x, state);
        }
}

/* *Mpfq::defaults::vec::generic::code_for_vec_random2, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_3_vec_random2(mpfq_p_3_dst_field k, mpfq_p_3_dst_vec w, unsigned int n, gmp_randstate_t state)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_dst_elt x = mpfq_p_3_vec_coeff_ptr(k, w, i);
        mpfq_p_3_random2(k, x, state);
        }
}

/* *Mpfq::defaults::vec::generic::code_for_vec_cmp, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_3_vec_cmp(mpfq_p_3_dst_field k, mpfq_p_3_src_vec u, mpfq_p_3_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, u, i);
            mpfq_p_3_src_elt y = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        int ret = mpfq_p_3_cmp(k, x, y);
        if (ret != 0)
            return ret;
        }
        return 0;
...
int mpfq_p_3_vec_is_zero(mpfq_p_3_dst_field k, mpfq_p_3_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_3_is_zero(k, x))
            return 0;
        }
        return 1;
}
...
int mpfq_p_3_vec_hamming_weight(mpfq_p_3_dst_field k, mpfq_p_3_src_vec v, unsigned int n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        w += !mpfq_p_3_is_zero(k, x);
        }
        return w;
}

/* *Mpfq::defaults::vec::generic::code_for_vec_find_first_set, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_3_vec_find_first_set(mpfq_p_3_dst_field k, mpfq_p_3_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_3_is_zero(k, x))
...
int mpfq_p_3_vec_simd_hamming_weight(mpfq_p_3_dst_field k, mpfq_p_3_src_vec v, unsigned int n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        w += mpfq_p_3_simd_hamming_weight(k, x);
        }
        return w;
}

/* *Mpfq::defaults::vec::generic::code_for_vec_simd_find_first_set, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_3_vec_simd_find_first_set(mpfq_p_3_dst_field k, mpfq_p_3_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_3_src_elt x = mpfq_p_3_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_3_is_zero(k, x))
            return i * mpfq_p_3_simd_groupsize(k) + mpfq_p_3_simd_hamming_weight(k, x);
        }
        return -1;
}
...
void mpfq_p_3_poly_setmonic(mpfq_p_3_dst_field K MAYBE_UNUSED, mpfq_p_3_dst_poly q, mpfq_p_3_src_poly p)
{
    ...
    mpfq_p_3_elt lc;	/* spurious uninit warning sometimes */
    mpfq_p_3_init(K, &lc);
...
void mpfq_p_3_add_dotprod(mpfq_p_3_dst_field K MAYBE_UNUSED, mpfq_p_3_dst_vec xw, mpfq_p_3_src_vec xu1, mpfq_p_3_src_vec xu0, unsigned int n)
{
        mpfq_p_3_elt_ur s,t;
        mpfq_p_3_elt_ur_init(K, &s);
        mpfq_p_3_elt_ur_init(K, &t);
        mpfq_p_3_elt_ur_set_elt(K, s, xw[0]);
        for(unsigned int i = 0 ; i < n ; i++) {
...
static void mpfq_p_3_wrapper_add_dotprod(mpfq_vbase_ptr, mpfq_p_3_dst_vec, mpfq_p_3_src_vec, mpfq_p_3_src_vec, unsigned int);
static void mpfq_p_3_wrapper_add_dotprod(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_vec xw MAYBE_UNUSED, mpfq_p_3_src_vec xu1 MAYBE_UNUSED, mpfq_p_3_src_vec xu0 MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_3_add_dotprod(vbase->obj, xw, xu1, xu0, n);
}

static void mpfq_p_3_wrapper_simd_set_ui_all(mpfq_vbase_ptr, mpfq_p_3_dst_elt, unsigned long);
static void mpfq_p_3_wrapper_simd_set_ui_all(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_elt p MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_3_simd_set_ui_all(vbase->obj, p, v);
}

static void mpfq_p_3_wrapper_simd_add_ui_at(mpfq_vbase_ptr, mpfq_p_3_dst_elt, mpfq_p_3_src_elt, int, unsigned long);
static void mpfq_p_3_wrapper_simd_add_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_elt p MAYBE_UNUSED, mpfq_p_3_src_elt p0 MAYBE_UNUSED, int k MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_3_simd_add_ui_at(vbase->obj, p, p0, k, v);
}

static void mpfq_p_3_wrapper_simd_set_ui_at(mpfq_vbase_ptr, mpfq_p_3_dst_elt, int, unsigned long);
static void mpfq_p_3_wrapper_simd_set_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_elt p MAYBE_UNUSED, int k MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_3_simd_set_ui_at(vbase->obj, p, k, v);
}

static unsigned long mpfq_p_3_wrapper_simd_get_ui_at(mpfq_vbase_ptr, mpfq_p_3_src_elt, int);
static unsigned long mpfq_p_3_wrapper_simd_get_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_elt p MAYBE_UNUSED, int k MAYBE_UNUSED)
{
    return mpfq_p_3_simd_get_ui_at(vbase->obj, p, k);
}

static int mpfq_p_3_wrapper_simd_find_first_set(mpfq_vbase_ptr, mpfq_p_3_src_elt);
static int mpfq_p_3_wrapper_simd_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_elt p MAYBE_UNUSED)
{
    return mpfq_p_3_simd_find_first_set(vbase->obj, p);
}

static int mpfq_p_3_wrapper_simd_hamming_weight(mpfq_vbase_ptr, mpfq_p_3_src_elt);
static int mpfq_p_3_wrapper_simd_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_elt p MAYBE_UNUSED)
{
    return mpfq_p_3_simd_hamming_weight(vbase->obj, p);
}

static int mpfq_p_3_wrapper_simd_groupsize(mpfq_vbase_ptr);
static int mpfq_p_3_wrapper_simd_groupsize(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_3_simd_groupsize(vbase->obj);
}
...
static void mpfq_p_3_wrapper_vec_scal_mul_ur(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_vec_ur w MAYBE_UNUSED, mpfq_p_3_src_vec u MAYBE_UNUSED, mpfq_p_3_src_elt c MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_3_vec_scal_mul_ur(vbase->obj, w, u, c, n);
}
...
static int mpfq_p_3_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr, mpfq_p_3_src_vec, unsigned int);
static int mpfq_p_3_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_3_vec_simd_find_first_set(vbase->obj, v, n);
}

static int mpfq_p_3_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr, mpfq_p_3_src_vec, unsigned int);
static int mpfq_p_3_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_3_vec_simd_hamming_weight(vbase->obj, v, n);
}

static int mpfq_p_3_wrapper_vec_find_first_set(mpfq_vbase_ptr, mpfq_p_3_src_vec, unsigned int);
static int mpfq_p_3_wrapper_vec_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_3_vec_find_first_set(vbase->obj, v, n);
}

static int mpfq_p_3_wrapper_vec_hamming_weight(mpfq_vbase_ptr, mpfq_p_3_src_vec, unsigned int);
static int mpfq_p_3_wrapper_vec_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_3_vec_hamming_weight(vbase->obj, v, n);
}
...
static int mpfq_p_3_wrapper_vec_is_zero(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_3_vec_is_zero(vbase->obj, v, n);
}
...
static void mpfq_p_3_wrapper_vec_scal_mul(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_vec w MAYBE_UNUSED, mpfq_p_3_src_vec u MAYBE_UNUSED, mpfq_p_3_src_elt c MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_3_vec_scal_mul(vbase->obj, w, u, c, n);
}
...
static ptrdiff_t mpfq_p_3_wrapper_elt_ur_stride(mpfq_vbase_ptr);
static ptrdiff_t mpfq_p_3_wrapper_elt_ur_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_3_elt_ur_stride(vbase->obj);
}
...
static void mpfq_p_3_wrapper_get_mpz(mpfq_vbase_ptr, mpz_ptr, mpfq_p_3_src_elt);
static void mpfq_p_3_wrapper_get_mpz(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpz_ptr z MAYBE_UNUSED, mpfq_p_3_src_elt y MAYBE_UNUSED)
{
...
static void mpfq_p_3_wrapper_set_mpz(mpfq_vbase_ptr, mpfq_p_3_dst_elt, mpz_srcptr);
static void mpfq_p_3_wrapper_set_mpz(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_3_dst_elt r MAYBE_UNUSED, mpz_srcptr z MAYBE_UNUSED)
{
...
static ptrdiff_t mpfq_p_3_wrapper_elt_stride(mpfq_vbase_ptr);
static ptrdiff_t mpfq_p_3_wrapper_elt_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_3_elt_stride(vbase->obj);
}
...
static void mpfq_p_3_wrapper_field_characteristic(mpfq_vbase_ptr, mpz_ptr);
static void mpfq_p_3_wrapper_field_characteristic(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpz_ptr z MAYBE_UNUSED)
{
...
void mpfq_p_3_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->field_characteristic = (void (*) (mpfq_vbase_ptr, mpz_ptr)) mpfq_p_3_wrapper_field_characteristic;
    ...
    vbase->elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr)) mpfq_p_3_wrapper_elt_stride;
    ...
    vbase->set_mpz = (void (*) (mpfq_vbase_ptr, void *, mpz_srcptr)) mpfq_p_3_wrapper_set_mpz;
    vbase->get_mpn = (void (*) (mpfq_vbase_ptr, mp_limb_t *, const void *)) mpfq_p_3_wrapper_get_mpn;
    vbase->get_mpz = (void (*) (mpfq_vbase_ptr, mpz_ptr, const void *)) mpfq_p_3_wrapper_get_mpz;
    ...
    vbase->elt_ur_stride = (ptrdiff_t (*) (mpfq_vbase_ptr)) mpfq_p_3_wrapper_elt_ur_stride;
    ...
    /* missing vec_import */
    /* missing vec_export */
    vbase->vec_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_3_wrapper_vec_hamming_weight;
    vbase->vec_find_first_set = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_3_wrapper_vec_find_first_set;
    vbase->vec_simd_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_3_wrapper_vec_simd_hamming_weight;
    vbase->vec_simd_find_first_set = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_3_wrapper_vec_simd_find_first_set;
    ...
    vbase->simd_groupsize = (int (*) (mpfq_vbase_ptr)) mpfq_p_3_wrapper_simd_groupsize;
    vbase->simd_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_3_wrapper_simd_hamming_weight;
    vbase->simd_find_first_set = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_3_wrapper_simd_find_first_set;
    vbase->simd_get_ui_at = (unsigned long (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_3_wrapper_simd_get_ui_at;
    vbase->simd_set_ui_at = (void (*) (mpfq_vbase_ptr, void *, int, unsigned long)) mpfq_p_3_wrapper_simd_set_ui_at;
    vbase->simd_add_ui_at = (void (*) (mpfq_vbase_ptr, void *, const void *, int, unsigned long)) mpfq_p_3_wrapper_simd_add_ui_at;
    vbase->simd_set_ui_all = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_3_wrapper_simd_set_ui_all;
    vbase->add_dotprod = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_3_wrapper_add_dotprod;
