...
void mpfq_p_4_dotprod(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec xw, mpfq_p_4_src_vec xu1, mpfq_p_4_src_vec xu0, unsigned int n)
{
        mpfq_p_4_elt_ur s,t;
        mpfq_p_4_elt_ur_init(K, &s);
        mpfq_p_4_elt_ur_init(K, &t);
        mpfq_p_4_elt_ur_set_zero(K, s);
        for(unsigned int i = 0 ; i < n ; i++) {
...
void mpfq_p_4_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->dotprod = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_dotprod;
