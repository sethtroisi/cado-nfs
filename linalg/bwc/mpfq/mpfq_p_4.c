...
#include <inttypes.h>
static int mpfq_p_4_impl_mpi_attr;     /* for MPI functions */
static MPI_Datatype mpfq_p_4_impl_mpi_datatype;
static MPI_Datatype mpfq_p_4_impl_mpi_datatype_ur;
static MPI_Op mpfq_p_4_impl_mpi_addition_op;
static MPI_Op mpfq_p_4_impl_mpi_addition_op_ur;
static int mpfq_p_4_impl_mpi_use_count;   /* several stacked init()/clear() pairs are supported */
...
void mpfq_p_4_field_specify(mpfq_p_4_dst_field k, unsigned long dummy MAYBE_UNUSED, void * vp)
{
...
void mpfq_p_4_poly_divmod(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly q, mpfq_p_4_dst_poly r, mpfq_p_4_src_poly a, mpfq_p_4_src_poly b)
{
    if (b->size == 0) {
...
void mpfq_p_4_mpi_ops_init(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
        if (mpfq_p_4_impl_mpi_use_count++) return;
    MPI_Type_create_keyval(MPI_TYPE_DUP_FN, MPI_TYPE_NULL_DELETE_FN, &mpfq_p_4_impl_mpi_attr, NULL);
    MPI_Type_contiguous(mpfq_p_4_vec_elt_stride(K, 1), MPI_BYTE, &mpfq_p_4_impl_mpi_datatype);
    MPI_Type_commit(&mpfq_p_4_impl_mpi_datatype);
    MPI_Type_contiguous(mpfq_p_4_vec_ur_elt_stride(K, 1), MPI_BYTE, &mpfq_p_4_impl_mpi_datatype_ur);
    MPI_Type_commit(&mpfq_p_4_impl_mpi_datatype_ur);
    MPI_Type_set_attr(mpfq_p_4_impl_mpi_datatype, mpfq_p_4_impl_mpi_attr, K);
    MPI_Type_set_attr(mpfq_p_4_impl_mpi_datatype_ur, mpfq_p_4_impl_mpi_attr, K);
    /* 1 here indicates that our operation is always taken to be
     * commutative */
    MPI_Op_create(&mpfq_p_4_mpi_op_inner, 1, &mpfq_p_4_impl_mpi_addition_op);
    MPI_Op_create(&mpfq_p_4_mpi_op_inner_ur, 1, &mpfq_p_4_impl_mpi_addition_op_ur);
}

/* *Mpfq::defaults::mpi_flat::code_for_mpi_datatype */
MPI_Datatype mpfq_p_4_mpi_datatype(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
    return mpfq_p_4_impl_mpi_datatype;
}

/* *Mpfq::defaults::mpi_flat::code_for_mpi_datatype_ur */
MPI_Datatype mpfq_p_4_mpi_datatype_ur(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
    return mpfq_p_4_impl_mpi_datatype_ur;
}

/* *Mpfq::defaults::mpi_flat::code_for_mpi_addition_op */
MPI_Op mpfq_p_4_mpi_addition_op(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
    return mpfq_p_4_impl_mpi_addition_op;
}

/* *Mpfq::defaults::mpi_flat::code_for_mpi_addition_op_ur */
MPI_Op mpfq_p_4_mpi_addition_op_ur(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
    return mpfq_p_4_impl_mpi_addition_op_ur;
}

/* *Mpfq::defaults::mpi_flat::code_for_mpi_ops_clear */
void mpfq_p_4_mpi_ops_clear(mpfq_p_4_dst_field K MAYBE_UNUSED)
{
        if (--mpfq_p_4_impl_mpi_use_count) return;
    MPI_Op_free(&mpfq_p_4_impl_mpi_addition_op);
    MPI_Op_free(&mpfq_p_4_impl_mpi_addition_op_ur);
    MPI_Type_delete_attr(mpfq_p_4_impl_mpi_datatype, mpfq_p_4_impl_mpi_attr);
    MPI_Type_delete_attr(mpfq_p_4_impl_mpi_datatype_ur, mpfq_p_4_impl_mpi_attr);
    MPI_Type_free(&mpfq_p_4_impl_mpi_datatype);
    MPI_Type_free(&mpfq_p_4_impl_mpi_datatype_ur);
    MPI_Type_free_keyval(&mpfq_p_4_impl_mpi_attr);
}
...
static void mpfq_p_4_wrapper_poly_divmod(mpfq_vbase_ptr, mpfq_p_4_dst_poly, mpfq_p_4_dst_poly, mpfq_p_4_src_poly, mpfq_p_4_src_poly);
static void mpfq_p_4_wrapper_poly_divmod(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_poly q MAYBE_UNUSED, mpfq_p_4_dst_poly r MAYBE_UNUSED, mpfq_p_4_src_poly a MAYBE_UNUSED, mpfq_p_4_src_poly b MAYBE_UNUSED)
{
    mpfq_p_4_poly_divmod(vbase->obj, q, r, a, b);
}
...
void mpfq_p_4_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->field_characteristic = (void (*) (mpfq_vbase_ptr, mpz_t)) mpfq_p_4_wrapper_field_characteristic;
    ...
    vbase->field_specify = (void (*) (mpfq_vbase_ptr, unsigned long, void *)) mpfq_p_4_wrapper_field_specify;
    ...
    vbase->set_mpz = (void (*) (mpfq_vbase_ptr, void *, mpz_t)) mpfq_p_4_wrapper_set_mpz;
    vbase->get_mpn = (void (*) (mpfq_vbase_ptr, mp_limb_t *, const void *)) mpfq_p_4_wrapper_get_mpn;
    vbase->get_mpz = (void (*) (mpfq_vbase_ptr, mpz_t, const void *)) mpfq_p_4_wrapper_get_mpz;
    ...
    vbase->poly_divmod = (void (*) (mpfq_vbase_ptr, void *, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_divmod;
    ...
    vbase->groupsize = (int (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_groupsize;
    vbase->offset = (int (*) (mpfq_vbase_ptr, int)) mpfq_p_4_wrapper_offset;
    vbase->stride = (int (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_stride;
    vbase->set_ui_at = (void (*) (mpfq_vbase_ptr, void *, int, unsigned long)) mpfq_p_4_wrapper_set_ui_at;
    vbase->set_ui_all = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_set_ui_all;
    vbase->elt_ur_set_ui_at = (void (*) (mpfq_vbase_ptr, void *, int, unsigned long)) mpfq_p_4_wrapper_elt_ur_set_ui_at;
    vbase->elt_ur_set_ui_all = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_elt_ur_set_ui_all;
    vbase->dotprod = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_dotprod;
    vbase->mpi_ops_init = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_ops_init;
    vbase->mpi_datatype = (MPI_Datatype (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_datatype;
    vbase->mpi_datatype_ur = (MPI_Datatype (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_datatype_ur;
    vbase->mpi_addition_op = (MPI_Op (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_addition_op;
    vbase->mpi_addition_op_ur = (MPI_Op (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_addition_op_ur;
    vbase->mpi_ops_clear = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_mpi_ops_clear;
