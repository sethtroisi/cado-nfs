...
void mpfq_p_4_field_clear(mpfq_p_4_dst_field k)
{
        mpz_clear(k->p);
...
void mpfq_p_4_field_specify(mpfq_p_4_dst_field k, unsigned long dummy MAYBE_UNUSED, const void * vp)
{
...
static void mpfq_p_4_init_ts(mpfq_p_4_dst_field k)
{
    ...
    if (e-1 < 64) {
        ...
        mpfq_fixmp_4_long_lshift(s, (e-1)/64, (e-1)%64);
    }
    k->ts_info.e = e;
    ...
    mpfq_p_4_init(k, &z);
    mpfq_p_4_init(k, &r);
    mpfq_p_4_set_ui(k, r, 0);
    do {
        mpfq_p_4_random(k, z, rstate);
        mpfq_p_4_pow(k, z, z, pp, 4);
        mpfq_p_4_pow(k, r, z, s, 4);
        mpfq_p_4_add_ui(k, r, r, 1);
    } while (mpfq_p_4_cmp_ui(k, r, 0)!=0);
    mpfq_p_4_set(k, (mpfq_p_4_dst_elt)k->ts_info.z, z);
    mpfq_p_4_clear(k, &z);
    mpfq_p_4_clear(k, &r);
...
/* *Mpfq::gfp::elt::code_for_sqrt, Mpfq::gfp */
int mpfq_p_4_sqrt(mpfq_p_4_dst_field k, mpfq_p_4_dst_elt z, mpfq_p_4_src_elt a)
{
    if (mpfq_p_4_cmp_ui(k, a, 0) == 0) {
        mpfq_p_4_set_ui(k, z, 0);
        return 1;
    }
    if (k->ts_info.e == 0)
        mpfq_p_4_init_ts(k);
    ...
    mpfq_p_4_set(k, x, a);
    mpfq_p_4_set(k, y, (mpfq_p_4_src_elt)k->ts_info.z);
    
    mpfq_p_4_pow(k, x, a, k->ts_info.hh, 4);
    mpfq_p_4_sqr(k, b, x);
    mpfq_p_4_mul(k, x, x, a);
    mpfq_p_4_mul(k, b, b, a);
    ...
    for(;;) {
        mpfq_p_4_set(k, t, b);
        for(m=0; mpfq_p_4_cmp_ui(k, t, 1)!=0; m++)
            mpfq_p_4_sqr(k, t, t);
        assert(m<=r);
        ...
        mpfq_p_4_pow(k, t, y, &s, 1);
        mpfq_p_4_sqr(k, y, t);
        mpfq_p_4_mul(k, x, x, t);
        mpfq_p_4_mul(k, b, b, y);
    }
    mpfq_p_4_set(k, z, x);
    mpfq_p_4_clear(k, &t);
    mpfq_p_4_clear(k, &x);
...
void mpfq_p_4_powz(mpfq_p_4_dst_field k, mpfq_p_4_dst_elt y, mpfq_p_4_src_elt x, mpz_srcptr z)
{
        if (mpz_sgn(z) < 0) {
            mpz_t mz;
            mpz_init(mz);
            mpz_neg(mz, z);
            mpfq_p_4_powz(k, y, x, mz);
            mpfq_p_4_inv(k, y, y);
            mpz_clear(mz);
        } else if (mpz_sizeinbase(z, 2) > mpfq_p_4_field_degree(k) * mpfq_p_4_field_characteristic_bits(k)) {
            mpz_t zr;
            mpz_init(zr);
            mpz_t ppz;
            mpz_init(ppz);
            mpfq_p_4_field_characteristic(k, ppz);
            mpz_pow_ui(ppz,ppz,mpfq_p_4_field_degree(k));
            mpz_sub_ui(ppz,ppz,1);
            mpz_fdiv_r(zr, z, ppz);
            mpfq_p_4_powz(k, y, x, zr);
            mpz_clear(ppz);
            mpz_clear(zr);
        } else {
            mpfq_p_4_pow(k, y, x, z->_mp_d, mpz_size(z));
        }
}
...
int mpfq_p_4_asprint(mpfq_p_4_dst_field k, char * * pstr, mpfq_p_4_src_elt x)
{
    int i, n;
    mp_size_t size_x;
    i=4-1;
...
int mpfq_p_4_fprint(mpfq_p_4_dst_field k, FILE * file, mpfq_p_4_src_elt x)
{
    char *str;
    int rc;
    mpfq_p_4_asprint(k,&str,x);
...
int mpfq_p_4_sscan(mpfq_p_4_dst_field k, mpfq_p_4_dst_elt z, const char * str)
{
    mpz_t zz;
    mpz_init(zz);
    int nread;
...
int mpfq_p_4_fscan(mpfq_p_4_dst_field k, FILE * file, mpfq_p_4_dst_elt z)
{
    char *tmp;
    int allocated, len=0;
    int c, start=0;
...
void mpfq_p_4_vec_init(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec * v, unsigned int n)
{
    unsigned int i;
    *v = (mpfq_p_4_vec) malloc (n*sizeof(mpfq_p_4_elt));
    for(i = 0; i < n; i++)
        mpfq_p_4_init(K, (*v) + i);
}

/* *Mpfq::defaults::vec::alloc::code_for_vec_reinit, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_reinit(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec * v, unsigned int n, unsigned int m)
{
    if (n < m) { // increase size
        unsigned int i;
        *v = (mpfq_p_4_vec) realloc (*v, m * sizeof(mpfq_p_4_elt));
        for(i = n; i < m; i+=1)
            mpfq_p_4_init(K, (*v) + i);
    } else if (m < n) { // decrease size
        unsigned int i;
        for(i = m; i < n; i+=1)
            mpfq_p_4_clear(K, (*v) + i);
        *v = (mpfq_p_4_vec) realloc (*v, m * sizeof(mpfq_p_4_elt));
    }
}

/* *Mpfq::defaults::vec::alloc::code_for_vec_clear, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_clear(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec * v, unsigned int n)
{
        unsigned int i;
    for(i = 0; i < n; i+=1)
        mpfq_p_4_clear(K, (*v) + i);
...
void mpfq_p_4_vec_random(mpfq_p_4_dst_field k, mpfq_p_4_dst_vec w, unsigned int n, gmp_randstate_t state)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_dst_elt x = mpfq_p_4_vec_coeff_ptr(k, w, i);
        mpfq_p_4_random(k, x, state);
        }
}

/* *Mpfq::defaults::vec::generic::code_for_vec_random2, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_random2(mpfq_p_4_dst_field k, mpfq_p_4_dst_vec w, unsigned int n, gmp_randstate_t state)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_dst_elt x = mpfq_p_4_vec_coeff_ptr(k, w, i);
        mpfq_p_4_random2(k, x, state);
        }
}

/* *Mpfq::defaults::vec::generic::code_for_vec_cmp, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_4_vec_cmp(mpfq_p_4_dst_field k, mpfq_p_4_src_vec u, mpfq_p_4_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, u, i);
            mpfq_p_4_src_elt y = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        int ret = mpfq_p_4_cmp(k, x, y);
        if (ret != 0)
            return ret;
        }
        return 0;
...
int mpfq_p_4_vec_is_zero(mpfq_p_4_dst_field k, mpfq_p_4_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_4_is_zero(k, x))
            return 0;
        }
        return 1;
}
...
int mpfq_p_4_vec_asprint(mpfq_p_4_dst_field K MAYBE_UNUSED, char * * pstr, mpfq_p_4_src_vec w, unsigned int n)
{
    if (n == 0) {
...
int mpfq_p_4_vec_fprint(mpfq_p_4_dst_field K MAYBE_UNUSED, FILE * file, mpfq_p_4_src_vec w, unsigned int n)
{
    char *str;
    int rc;
    mpfq_p_4_vec_asprint(K,&str,w,n);
    rc = fprintf(file,"%s",str);
    free(str);
    return rc;
}
...
int mpfq_p_4_vec_print(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_src_vec w, unsigned int n)
{
    return mpfq_p_4_vec_fprint(K,stdout,w,n);
}

/* *Mpfq::defaults::vec::io::code_for_vec_sscan, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_4_vec_sscan(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec * w, unsigned int * n, const char * str)
{
...
int mpfq_p_4_vec_fscan(mpfq_p_4_dst_field K MAYBE_UNUSED, FILE * file, mpfq_p_4_vec * w, unsigned int * n)
{
    char *tmp;
    int c;
    int allocated, len=0;
    ...
    tmp[len]='\0';
    int ret=mpfq_p_4_vec_sscan(K,w,n,tmp);
    free(tmp);
    return ret;
}

/* *Mpfq::defaults::vec::generic::code_for_vec_hamming_weight, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_4_vec_hamming_weight(mpfq_p_4_dst_field k, mpfq_p_4_src_vec v, unsigned int n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        w += !mpfq_p_4_is_zero(k, x);
        }
        return w;
}

/* *Mpfq::defaults::vec::generic::code_for_vec_find_first_set, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_4_vec_find_first_set(mpfq_p_4_dst_field k, mpfq_p_4_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_4_is_zero(k, x))
...
int mpfq_p_4_vec_simd_hamming_weight(mpfq_p_4_dst_field k, mpfq_p_4_src_vec v, unsigned int n)
{
        int w = 0;
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        w += mpfq_p_4_simd_hamming_weight(k, x);
        }
        return w;
}

/* *Mpfq::defaults::vec::generic::code_for_vec_simd_find_first_set, Mpfq::defaults::vec, Mpfq::gfp */
int mpfq_p_4_vec_simd_find_first_set(mpfq_p_4_dst_field k, mpfq_p_4_src_vec v, unsigned int n)
{
        for (unsigned int i = 0; i < n; ++i) {
            mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(k, v, i);
        if (!mpfq_p_4_is_zero(k, x))
            return i * mpfq_p_4_simd_groupsize(k) + mpfq_p_4_simd_hamming_weight(k, x);
        }
        return -1;
}

/* *Mpfq::defaults::vec::alloc::code_for_vec_ur_init, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_ur_init(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec_ur * v, unsigned int n)
{
    unsigned int i;
    *v = (mpfq_p_4_vec_ur) malloc (n*sizeof(mpfq_p_4_elt_ur));
    for(i = 0; i < n; i+=1)
        mpfq_p_4_elt_ur_init(K, &( (*v)[i]));
}

/* *Mpfq::defaults::vec::alloc::code_for_vec_ur_reinit, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_ur_reinit(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec_ur * v, unsigned int n, unsigned int m)
{
    if (n < m) { // increase size
        *v = (mpfq_p_4_vec_ur) realloc (*v, m * sizeof(mpfq_p_4_elt_ur));
        unsigned int i;
        for(i = n; i < m; i+=1)
            mpfq_p_4_elt_ur_init(K, (*v) + i);
    } else if (m < n) { // decrease size
        unsigned int i;
        for(i = m; i < n; i+=1)
            mpfq_p_4_elt_ur_clear(K, (*v) + i);
        *v = (mpfq_p_4_vec_ur) realloc (*v, m * sizeof(mpfq_p_4_elt_ur));
    }
}

/* *Mpfq::defaults::vec::alloc::code_for_vec_ur_clear, Mpfq::defaults::vec, Mpfq::gfp */
void mpfq_p_4_vec_ur_clear(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_vec_ur * v, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i+=1)
        mpfq_p_4_elt_ur_clear(K, &( (*v)[i]));
...
void mpfq_p_4_vec_conv_ur_ks(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec_ur w, mpfq_p_4_src_vec u, unsigned int n, mpfq_p_4_src_vec v, unsigned int m)
{
    ...
    mpz_t p;
    mpz_init(p);
    mpfq_p_4_field_characteristic(K, p);
    mpz_sub_ui(p, p, 1);
    mpz_mul(p, p, p);
    ...
    assert(sizeof(mpfq_p_4_elt_ur) >= nwords*sizeof(unsigned long));
    ...
    for (i = 0; i < n; ++i)
        mpfq_p_4_get_mpn(K, U->_mp_d + i*nwords, u[i]);
    ...
    for (i = 0; i < m; ++i)
        mpfq_p_4_get_mpn(K, V->_mp_d + i*nwords, v[i]);
    ...
    if (sizeof(mpfq_p_4_elt_ur) == nwords*sizeof(unsigned long)) {
        for (i = 0; i < m+n-1; ++i) 
            mpfq_p_4_elt_ur_set(K, w[i], (mpfq_p_4_src_elt_ur)(W->_mp_d + i*nwords));
    } else {
        for (i = 0; i < m+n-1; ++i) {
            mpfq_p_4_elt_ur_set_ui(K, w[i], 0);
...
void mpfq_p_4_poly_setmonic(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly q, mpfq_p_4_src_poly p)
{
    long degp = mpfq_p_4_poly_deg(K, p);
    if (degp == -1) {
        q->size = 0;
        return;
    }
    if (degp == 0) {
        mpfq_p_4_elt aux;
        mpfq_p_4_init(K, &aux);
        mpfq_p_4_set_ui(K, aux, 1);
        mpfq_p_4_poly_setcoeff(K, q, aux, 0);
        mpfq_p_4_clear(K, &aux);
        q->size = 1;
        return;
    }
    mpfq_p_4_elt lc;	/* spurious uninit warning sometimes */
    mpfq_p_4_init(K, &lc);
    mpfq_p_4_poly_getcoeff(K, lc, p, degp);
    mpfq_p_4_inv(K, lc, lc);
    mpfq_p_4_poly_setcoeff_ui(K, q, 1, degp);
    mpfq_p_4_vec_scal_mul(K, q->c, p->c, lc, degp);
    q->size = degp+1;
    mpfq_p_4_clear(K, &lc);
}

/* *Mpfq::defaults::poly::code_for_poly_divmod, Mpfq::gfp */
int mpfq_p_4_poly_divmod(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly q, mpfq_p_4_dst_poly r, mpfq_p_4_src_poly a, mpfq_p_4_src_poly b)
{
    if (b->size == 0) {
        return 0;
    }
    ...
    int dega = mpfq_p_4_poly_deg(K, a);
    if (dega<0) {
        q->size = 0; r->size = 0;
        return 1;
    }
    // Compute deg b and inverse of leading coef
    int degb = mpfq_p_4_poly_deg(K, b);
    if (degb<0) {
        return 0;
    }
    if (degb > dega) {
        q->size=0;
        mpfq_p_4_poly_set(K, r, a);
        return 1;
    }
    int bmonic;
    mpfq_p_4_elt ilb;
    ...
    if (mpfq_p_4_cmp_ui(K, temp, 1) == 0) {
        ...
        mpfq_p_4_inv(K, ilb, temp);
        bmonic = 0;
    }
    
    mpfq_p_4_poly qq, rr;
    mpfq_p_4_poly_init(K, qq, dega-degb+1);
    mpfq_p_4_poly_init(K, rr, dega);
    
    mpfq_p_4_poly_set(K, rr, a);
    mpfq_p_4_elt aux, aux2;
    
    mpfq_p_4_init(K, &aux);
    mpfq_p_4_init(K, &aux2);
    
    int i;
    int j;
    for (i = dega; i >= (int)degb; --i) {
        mpfq_p_4_poly_getcoeff(K, aux, rr, i);
        if (!bmonic) 
            mpfq_p_4_mul(K, aux, aux, ilb);
        mpfq_p_4_poly_setcoeff(K, qq, aux, i-degb);
        for (j = i-1; j >= (int)(i - degb); --j) {
            mpfq_p_4_poly_getcoeff(K, temp, b, j-i+degb);
            mpfq_p_4_mul(K, aux2, aux, temp);
            mpfq_p_4_poly_getcoeff(K, temp, rr, j);
    
            mpfq_p_4_sub(K, temp, temp, aux2);
            mpfq_p_4_poly_setcoeff(K, rr, temp, j);
        }
    }    
    
    rr->size = degb;
    int degr = mpfq_p_4_poly_deg(K, rr);
    rr->size = degr+1;
    
    if (q != NULL) 
        mpfq_p_4_poly_set(K, q, qq);
    if (r != NULL)
        mpfq_p_4_poly_set(K, r, rr);
    mpfq_p_4_clear(K, &temp);
    mpfq_p_4_clear(K, &ilb);
    mpfq_p_4_clear(K, &aux);
    mpfq_p_4_clear(K, &aux2);
    mpfq_p_4_poly_clear(K, rr);
    mpfq_p_4_poly_clear(K, qq);
    return 1;
}
...
static void mpfq_p_4_poly_preinv(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly q, mpfq_p_4_src_poly p, unsigned int n)
{
    ...
    int m;
    if (n <= 2) {
        mpfq_p_4_poly_setcoeff_ui(K, q, 1, 0);
        q->size = 1;
        m = 1;
        if (n == 1)
            return;
    ...
    // refine value
    mpfq_p_4_vec tmp;
    mpfq_p_4_vec_init(K, &tmp, m+n-1);
    
    mpfq_p_4_vec_conv(K, tmp, p->c, MIN(n, p->size), q->c, m);
    int nn = MIN(n, MIN(n, p->size) + m -1);
    mpfq_p_4_vec_neg(K, tmp, tmp, nn);
    mpfq_p_4_vec_getcoeff(K, temp, tmp, 0);
    mpfq_p_4_add_ui(K, temp, temp, 1);
    mpfq_p_4_vec_setcoeff(K, tmp, temp, 0);
    mpfq_p_4_vec_conv(K, tmp, q->c, m, tmp, nn);
    mpfq_p_4_vec_set(K, mpfq_p_4_vec_subvec(K, q->c, m), mpfq_p_4_vec_subvec(K, tmp, m), n-m);
    q->size = n;
    
    mpfq_p_4_clear(K, &temp);
    mpfq_p_4_vec_clear(K, &tmp, m+n-1);
}

/* *Mpfq::defaults::poly::code_for_poly_precomp_mod, Mpfq::gfp */
void mpfq_p_4_poly_precomp_mod(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly q, mpfq_p_4_src_poly p)
{
    assert(p != q);
    ...
    rp->size = N+1;
    mpfq_p_4_poly_preinv(K, q, rp, N);
    mpfq_p_4_poly_clear(K, rp);
}

/* *Mpfq::defaults::poly::code_for_poly_mod_pre, Mpfq::gfp */
void mpfq_p_4_poly_mod_pre(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_poly r, mpfq_p_4_src_poly q, mpfq_p_4_src_poly p, mpfq_p_4_src_poly irp)
{
    int N = mpfq_p_4_poly_deg(K, p);
    int degq = mpfq_p_4_poly_deg(K, q);
    if (degq < N) {
        mpfq_p_4_poly_set(K, r, q);
        return;
    }
    int m = degq - N;
    assert (degq <= 2*N-2);
    mpfq_p_4_poly revq;
    mpfq_p_4_poly_init(K, revq, MAX(degq+1, m+1));
    mpfq_p_4_vec_rev(K, revq->c, q->c, degq+1);
    revq->size = q->size;
    mpfq_p_4_poly_mul(K, revq, revq, irp);
    mpfq_p_4_vec_rev(K, revq->c, revq->c, m+1);
    revq->size = m+1;
    
    mpfq_p_4_poly_mul(K, revq, revq, p);
    mpfq_p_4_poly_sub(K, r, q, revq);
    r->size = mpfq_p_4_poly_deg(K, r)+1;
    mpfq_p_4_poly_clear(K, revq);
}


/* Functions related to SIMD operation */
/* *simd_gfp::code_for_add_dotprod */
void mpfq_p_4_add_dotprod(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec xw, mpfq_p_4_src_vec xu1, mpfq_p_4_src_vec xu0, unsigned int n)
{
        mpfq_p_4_elt_ur s,t;
        mpfq_p_4_elt_ur_init(K, &s);
        mpfq_p_4_elt_ur_init(K, &t);
        mpfq_p_4_elt_ur_set_elt(K, s, xw[0]);
        for(unsigned int i = 0 ; i < n ; i++) {
            mpfq_p_4_mul_ur(K, t, xu0[i], xu1[i]);
            mpfq_p_4_elt_ur_add(K, s, s, t);
        }
        mpfq_p_4_reduce(K, xw[0], s);
        mpfq_p_4_elt_ur_clear(K, &s);
        mpfq_p_4_elt_ur_clear(K, &t);
}
...
static void mpfq_p_4_wrapper_oo_field_init(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    mpfq_p_4_oo_field_init(vbase);
}

static void mpfq_p_4_wrapper_add_dotprod(mpfq_vbase_ptr, mpfq_p_4_dst_vec, mpfq_p_4_src_vec, mpfq_p_4_src_vec, unsigned int);
static void mpfq_p_4_wrapper_add_dotprod(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_vec xw MAYBE_UNUSED, mpfq_p_4_src_vec xu1 MAYBE_UNUSED, mpfq_p_4_src_vec xu0 MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_4_add_dotprod(vbase->obj, xw, xu1, xu0, n);
}

static void mpfq_p_4_wrapper_simd_set_ui_all(mpfq_vbase_ptr, mpfq_p_4_dst_elt, unsigned long);
static void mpfq_p_4_wrapper_simd_set_ui_all(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_elt p MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_4_simd_set_ui_all(vbase->obj, p, v);
}

static void mpfq_p_4_wrapper_simd_add_ui_at(mpfq_vbase_ptr, mpfq_p_4_dst_elt, mpfq_p_4_src_elt, int, unsigned long);
static void mpfq_p_4_wrapper_simd_add_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_elt p MAYBE_UNUSED, mpfq_p_4_src_elt p0 MAYBE_UNUSED, int k MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_4_simd_add_ui_at(vbase->obj, p, p0, k, v);
}

static void mpfq_p_4_wrapper_simd_set_ui_at(mpfq_vbase_ptr, mpfq_p_4_dst_elt, int, unsigned long);
static void mpfq_p_4_wrapper_simd_set_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_elt p MAYBE_UNUSED, int k MAYBE_UNUSED, unsigned long v MAYBE_UNUSED)
{
    mpfq_p_4_simd_set_ui_at(vbase->obj, p, k, v);
}

static unsigned long mpfq_p_4_wrapper_simd_get_ui_at(mpfq_vbase_ptr, mpfq_p_4_src_elt, int);
static unsigned long mpfq_p_4_wrapper_simd_get_ui_at(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_elt p MAYBE_UNUSED, int k MAYBE_UNUSED)
{
    return mpfq_p_4_simd_get_ui_at(vbase->obj, p, k);
}

static int mpfq_p_4_wrapper_simd_find_first_set(mpfq_vbase_ptr, mpfq_p_4_src_elt);
static int mpfq_p_4_wrapper_simd_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_elt p MAYBE_UNUSED)
{
    return mpfq_p_4_simd_find_first_set(vbase->obj, p);
}

static int mpfq_p_4_wrapper_simd_hamming_weight(mpfq_vbase_ptr, mpfq_p_4_src_elt);
static int mpfq_p_4_wrapper_simd_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_elt p MAYBE_UNUSED)
{
    return mpfq_p_4_simd_hamming_weight(vbase->obj, p);
}

static int mpfq_p_4_wrapper_simd_groupsize(mpfq_vbase_ptr);
static int mpfq_p_4_wrapper_simd_groupsize(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_4_simd_groupsize(vbase->obj);
}
...
static void mpfq_p_4_wrapper_vec_scal_mul_ur(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_vec_ur w MAYBE_UNUSED, mpfq_p_4_src_vec u MAYBE_UNUSED, mpfq_p_4_src_elt c MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_4_vec_scal_mul_ur(vbase->obj, w, u, c, n);
}
...
static int mpfq_p_4_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr, mpfq_p_4_src_vec, unsigned int);
static int mpfq_p_4_wrapper_vec_simd_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_4_vec_simd_find_first_set(vbase->obj, v, n);
}

static int mpfq_p_4_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr, mpfq_p_4_src_vec, unsigned int);
static int mpfq_p_4_wrapper_vec_simd_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_4_vec_simd_hamming_weight(vbase->obj, v, n);
}

static int mpfq_p_4_wrapper_vec_find_first_set(mpfq_vbase_ptr, mpfq_p_4_src_vec, unsigned int);
static int mpfq_p_4_wrapper_vec_find_first_set(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_4_vec_find_first_set(vbase->obj, v, n);
}

static int mpfq_p_4_wrapper_vec_hamming_weight(mpfq_vbase_ptr, mpfq_p_4_src_vec, unsigned int);
static int mpfq_p_4_wrapper_vec_hamming_weight(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_4_vec_hamming_weight(vbase->obj, v, n);
}
...
static int mpfq_p_4_wrapper_vec_is_zero(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_src_vec v MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    return mpfq_p_4_vec_is_zero(vbase->obj, v, n);
}
...
static void mpfq_p_4_wrapper_vec_scal_mul(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_vec w MAYBE_UNUSED, mpfq_p_4_src_vec u MAYBE_UNUSED, mpfq_p_4_src_elt c MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_p_4_vec_scal_mul(vbase->obj, w, u, c, n);
}
...
static ptrdiff_t mpfq_p_4_wrapper_elt_ur_stride(mpfq_vbase_ptr);
static ptrdiff_t mpfq_p_4_wrapper_elt_ur_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_4_elt_ur_stride(vbase->obj);
}
...
static void mpfq_p_4_wrapper_get_mpz(mpfq_vbase_ptr, mpz_ptr, mpfq_p_4_src_elt);
static void mpfq_p_4_wrapper_get_mpz(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpz_ptr z MAYBE_UNUSED, mpfq_p_4_src_elt y MAYBE_UNUSED)
{
...
static void mpfq_p_4_wrapper_set_mpz(mpfq_vbase_ptr, mpfq_p_4_dst_elt, mpz_srcptr);
static void mpfq_p_4_wrapper_set_mpz(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_p_4_dst_elt r MAYBE_UNUSED, mpz_srcptr z MAYBE_UNUSED)
{
...
static ptrdiff_t mpfq_p_4_wrapper_elt_stride(mpfq_vbase_ptr);
static ptrdiff_t mpfq_p_4_wrapper_elt_stride(mpfq_vbase_ptr vbase MAYBE_UNUSED)
{
    return mpfq_p_4_elt_stride(vbase->obj);
}
...
static void mpfq_p_4_wrapper_field_specify(mpfq_vbase_ptr, unsigned long, const void *);
static void mpfq_p_4_wrapper_field_specify(mpfq_vbase_ptr vbase MAYBE_UNUSED, unsigned long dummy MAYBE_UNUSED, const void * vp MAYBE_UNUSED)
{
...
static void mpfq_p_4_wrapper_field_characteristic(mpfq_vbase_ptr, mpz_ptr);
static void mpfq_p_4_wrapper_field_characteristic(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpz_ptr z MAYBE_UNUSED)
{
...
void mpfq_p_4_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->obj = malloc(sizeof(mpfq_p_4_field));
    mpfq_p_4_field_init((mpfq_p_4_dst_field) vbase->obj);
    vbase->impl_name = (const char * (*) ()) mpfq_p_4_wrapper_impl_name;
    vbase->impl_max_characteristic_bits = (unsigned long (*) ()) mpfq_p_4_wrapper_impl_max_characteristic_bits;
    vbase->impl_max_degree = (unsigned long (*) ()) mpfq_p_4_wrapper_impl_max_degree;
    vbase->field_characteristic = (void (*) (mpfq_vbase_ptr, mpz_ptr)) mpfq_p_4_wrapper_field_characteristic;
    vbase->field_characteristic_bits = (unsigned long (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_field_characteristic_bits;
    vbase->field_degree = (int (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_field_degree;
    vbase->field_init = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_field_init;
    vbase->field_clear = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_field_clear;
    vbase->field_specify = (void (*) (mpfq_vbase_ptr, unsigned long, const void *)) mpfq_p_4_wrapper_field_specify;
    vbase->field_setopt = (void (*) (mpfq_vbase_ptr, unsigned long, void *)) mpfq_p_4_wrapper_field_setopt;
    vbase->init = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_init;
    vbase->clear = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_clear;
    vbase->elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_elt_stride;
    vbase->set = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_set;
    vbase->set_ui = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_set_ui;
    vbase->set_zero = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_set_zero;
    vbase->get_ui = (unsigned long (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_get_ui;
    vbase->set_mpn = (void (*) (mpfq_vbase_ptr, void *, mp_limb_t *, size_t)) mpfq_p_4_wrapper_set_mpn;
    vbase->set_mpz = (void (*) (mpfq_vbase_ptr, void *, mpz_srcptr)) mpfq_p_4_wrapper_set_mpz;
    vbase->get_mpn = (void (*) (mpfq_vbase_ptr, mp_limb_t *, const void *)) mpfq_p_4_wrapper_get_mpn;
    vbase->get_mpz = (void (*) (mpfq_vbase_ptr, mpz_ptr, const void *)) mpfq_p_4_wrapper_get_mpz;
    vbase->random = (void (*) (mpfq_vbase_ptr, void *, gmp_randstate_t)) mpfq_p_4_wrapper_random;
    vbase->random2 = (void (*) (mpfq_vbase_ptr, void *, gmp_randstate_t)) mpfq_p_4_wrapper_random2;
    vbase->add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_add;
    vbase->sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_sub;
    vbase->neg = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_neg;
    vbase->mul = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_mul;
    vbase->sqr = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_sqr;
    vbase->is_sqr = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_is_sqr;
    vbase->sqrt = (int (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_sqrt;
    vbase->pow = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long *, size_t)) mpfq_p_4_wrapper_pow;
    vbase->powz = (void (*) (mpfq_vbase_ptr, void *, const void *, mpz_srcptr)) mpfq_p_4_wrapper_powz;
    vbase->frobenius = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_frobenius;
    vbase->add_ui = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_p_4_wrapper_add_ui;
    vbase->sub_ui = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_p_4_wrapper_sub_ui;
    vbase->mul_ui = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_p_4_wrapper_mul_ui;
    vbase->normalize = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_normalize;
    vbase->inv = (int (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_inv;
    vbase->hadamard = (void (*) (mpfq_vbase_ptr, void *, void *, void *, void *)) mpfq_p_4_wrapper_hadamard;
    vbase->elt_ur_init = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_elt_ur_init;
    vbase->elt_ur_clear = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_elt_ur_clear;
    vbase->elt_ur_stride = (ptrdiff_t (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_elt_ur_stride;
    vbase->elt_ur_set = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_elt_ur_set;
    vbase->elt_ur_set_elt = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_elt_ur_set_elt;
    vbase->elt_ur_set_zero = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_elt_ur_set_zero;
    vbase->elt_ur_set_ui = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_elt_ur_set_ui;
    vbase->elt_ur_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_elt_ur_add;
    vbase->elt_ur_neg = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_elt_ur_neg;
    vbase->elt_ur_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_elt_ur_sub;
    vbase->mul_ur = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_mul_ur;
    vbase->sqr_ur = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_sqr_ur;
    vbase->reduce = (void (*) (mpfq_vbase_ptr, void *, void *)) mpfq_p_4_wrapper_reduce;
    vbase->addmul_si_ur = (void (*) (mpfq_vbase_ptr, void *, const void *, long)) mpfq_p_4_wrapper_addmul_si_ur;
    vbase->cmp = (int (*) (mpfq_vbase_ptr, const void *, const void *)) mpfq_p_4_wrapper_cmp;
    vbase->cmp_ui = (int (*) (mpfq_vbase_ptr, const void *, unsigned long)) mpfq_p_4_wrapper_cmp_ui;
    vbase->is_zero = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_is_zero;
    vbase->asprint = (int (*) (mpfq_vbase_ptr, char * *, const void *)) mpfq_p_4_wrapper_asprint;
    vbase->fprint = (int (*) (mpfq_vbase_ptr, FILE *, const void *)) mpfq_p_4_wrapper_fprint;
    vbase->print = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_print;
    ...
    vbase->vec_set = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_set;
    vbase->vec_set_zero = (void (*) (mpfq_vbase_ptr, void *, unsigned int)) mpfq_p_4_wrapper_vec_set_zero;
    vbase->vec_setcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_setcoeff;
    vbase->vec_setcoeff_ui = (void (*) (mpfq_vbase_ptr, void *, unsigned long, unsigned int)) mpfq_p_4_wrapper_vec_setcoeff_ui;
    vbase->vec_getcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_getcoeff;
    vbase->vec_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_add;
    vbase->vec_neg = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_neg;
    vbase->vec_rev = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_rev;
    vbase->vec_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_sub;
    vbase->vec_scal_mul = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_scal_mul;
    vbase->vec_conv = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int, const void *, unsigned int)) mpfq_p_4_wrapper_vec_conv;
    vbase->vec_random = (void (*) (mpfq_vbase_ptr, void *, unsigned int, gmp_randstate_t)) mpfq_p_4_wrapper_vec_random;
    vbase->vec_random2 = (void (*) (mpfq_vbase_ptr, void *, unsigned int, gmp_randstate_t)) mpfq_p_4_wrapper_vec_random2;
    vbase->vec_cmp = (int (*) (mpfq_vbase_ptr, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_cmp;
    vbase->vec_is_zero = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_is_zero;
    vbase->vec_subvec = (void * (*) (mpfq_vbase_ptr, void *, int)) mpfq_p_4_wrapper_vec_subvec;
    vbase->vec_subvec_const = (const void * (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_4_wrapper_vec_subvec_const;
    vbase->vec_coeff_ptr = (void * (*) (mpfq_vbase_ptr, void *, int)) mpfq_p_4_wrapper_vec_coeff_ptr;
    vbase->vec_coeff_ptr_const = (const void * (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_4_wrapper_vec_coeff_ptr_const;
    vbase->vec_asprint = (int (*) (mpfq_vbase_ptr, char * *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_asprint;
    vbase->vec_fprint = (int (*) (mpfq_vbase_ptr, FILE *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_fprint;
    vbase->vec_print = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_print;
    ...
    /* missing vec_import */
    /* missing vec_export */
    vbase->vec_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_hamming_weight;
    vbase->vec_find_first_set = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_find_first_set;
    vbase->vec_simd_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_simd_hamming_weight;
    vbase->vec_simd_find_first_set = (int (*) (mpfq_vbase_ptr, const void *, unsigned int)) mpfq_p_4_wrapper_vec_simd_find_first_set;
    ...
    vbase->vec_ur_reinit = (void (*) (mpfq_vbase_ptr, void *, unsigned int, unsigned int)) mpfq_p_4_wrapper_vec_ur_reinit;
    vbase->vec_ur_clear = (void (*) (mpfq_vbase_ptr, void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_clear;
    vbase->vec_ur_set = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_set;
    vbase->vec_ur_setcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_setcoeff;
    vbase->vec_ur_getcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_getcoeff;
    vbase->vec_ur_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_add;
    vbase->vec_ur_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_sub;
    vbase->vec_ur_neg = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_neg;
    vbase->vec_ur_rev = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_ur_rev;
    vbase->vec_scal_mul_ur = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_vec_scal_mul_ur;
    vbase->vec_conv_ur = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int, const void *, unsigned int)) mpfq_p_4_wrapper_vec_conv_ur;
    vbase->vec_reduce = (void (*) (mpfq_vbase_ptr, void *, void *, unsigned int)) mpfq_p_4_wrapper_vec_reduce;
    vbase->vec_ur_subvec = (void * (*) (mpfq_vbase_ptr, void *, int)) mpfq_p_4_wrapper_vec_ur_subvec;
    vbase->vec_ur_subvec_const = (const void * (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_4_wrapper_vec_ur_subvec_const;
    vbase->vec_ur_coeff_ptr = (void * (*) (mpfq_vbase_ptr, void *, int)) mpfq_p_4_wrapper_vec_ur_coeff_ptr;
    vbase->vec_ur_coeff_ptr_const = (const void * (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_4_wrapper_vec_ur_coeff_ptr_const;
    vbase->vec_elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr, int)) mpfq_p_4_wrapper_vec_elt_stride;
    vbase->vec_ur_elt_stride = (ptrdiff_t (*) (mpfq_vbase_ptr, int)) mpfq_p_4_wrapper_vec_ur_elt_stride;
    vbase->poly_init = (void (*) (mpfq_vbase_ptr, void *, unsigned int)) mpfq_p_4_wrapper_poly_init;
    vbase->poly_clear = (void (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_poly_clear;
    vbase->poly_set = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_poly_set;
    vbase->poly_setmonic = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_poly_setmonic;
    vbase->poly_setcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_poly_setcoeff;
    vbase->poly_setcoeff_ui = (void (*) (mpfq_vbase_ptr, void *, unsigned long, unsigned int)) mpfq_p_4_wrapper_poly_setcoeff_ui;
    vbase->poly_getcoeff = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned int)) mpfq_p_4_wrapper_poly_getcoeff;
    vbase->poly_deg = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_poly_deg;
    vbase->poly_add = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_add;
    vbase->poly_sub = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_sub;
    vbase->poly_set_ui = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_poly_set_ui;
    vbase->poly_add_ui = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_p_4_wrapper_poly_add_ui;
    vbase->poly_sub_ui = (void (*) (mpfq_vbase_ptr, void *, const void *, unsigned long)) mpfq_p_4_wrapper_poly_sub_ui;
    vbase->poly_neg = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_poly_neg;
    vbase->poly_scal_mul = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_scal_mul;
    vbase->poly_mul = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_mul;
    vbase->poly_divmod = (int (*) (mpfq_vbase_ptr, void *, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_divmod;
    vbase->poly_precomp_mod = (void (*) (mpfq_vbase_ptr, void *, const void *)) mpfq_p_4_wrapper_poly_precomp_mod;
    vbase->poly_mod_pre = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, const void *)) mpfq_p_4_wrapper_poly_mod_pre;
    vbase->poly_gcd = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_gcd;
    vbase->poly_xgcd = (void (*) (mpfq_vbase_ptr, void *, void *, void *, const void *, const void *)) mpfq_p_4_wrapper_poly_xgcd;
    vbase->poly_random = (void (*) (mpfq_vbase_ptr, void *, unsigned int, gmp_randstate_t)) mpfq_p_4_wrapper_poly_random;
    vbase->poly_random2 = (void (*) (mpfq_vbase_ptr, void *, unsigned int, gmp_randstate_t)) mpfq_p_4_wrapper_poly_random2;
    vbase->poly_cmp = (int (*) (mpfq_vbase_ptr, const void *, const void *)) mpfq_p_4_wrapper_poly_cmp;
    vbase->poly_asprint = (int (*) (mpfq_vbase_ptr, char * *, const void *)) mpfq_p_4_wrapper_poly_asprint;
    vbase->poly_fprint = (int (*) (mpfq_vbase_ptr, FILE *, const void *)) mpfq_p_4_wrapper_poly_fprint;
    vbase->poly_print = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_poly_print;
    vbase->poly_sscan = (int (*) (mpfq_vbase_ptr, void *, const char *)) mpfq_p_4_wrapper_poly_sscan;
    vbase->poly_fscan = (int (*) (mpfq_vbase_ptr, FILE *, void *)) mpfq_p_4_wrapper_poly_fscan;
    vbase->poly_scan = (int (*) (mpfq_vbase_ptr, void *)) mpfq_p_4_wrapper_poly_scan;
    vbase->simd_groupsize = (int (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_simd_groupsize;
    vbase->simd_hamming_weight = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_simd_hamming_weight;
    vbase->simd_find_first_set = (int (*) (mpfq_vbase_ptr, const void *)) mpfq_p_4_wrapper_simd_find_first_set;
    vbase->simd_get_ui_at = (unsigned long (*) (mpfq_vbase_ptr, const void *, int)) mpfq_p_4_wrapper_simd_get_ui_at;
    vbase->simd_set_ui_at = (void (*) (mpfq_vbase_ptr, void *, int, unsigned long)) mpfq_p_4_wrapper_simd_set_ui_at;
    vbase->simd_add_ui_at = (void (*) (mpfq_vbase_ptr, void *, const void *, int, unsigned long)) mpfq_p_4_wrapper_simd_add_ui_at;
    vbase->simd_set_ui_all = (void (*) (mpfq_vbase_ptr, void *, unsigned long)) mpfq_p_4_wrapper_simd_set_ui_all;
    vbase->add_dotprod = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_p_4_wrapper_add_dotprod;
    vbase->oo_field_init = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_oo_field_init;
    vbase->oo_field_clear = (void (*) (mpfq_vbase_ptr)) mpfq_p_4_wrapper_oo_field_clear;
}
