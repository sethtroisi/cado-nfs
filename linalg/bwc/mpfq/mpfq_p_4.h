...
static inline
void mpfq_p_4_field_characteristic(mpfq_p_4_dst_field, mpz_ptr);
static inline
...
void mpfq_p_4_field_specify(mpfq_p_4_dst_field, unsigned long, const void *);
...
#define mpfq_p_4_elt_stride(k)	sizeof(mpfq_p_4_elt)
...
static inline
void mpfq_p_4_set_mpz(mpfq_p_4_dst_field, mpfq_p_4_dst_elt, mpz_srcptr);
static inline
void mpfq_p_4_get_mpn(mpfq_p_4_dst_field, mp_limb_t *, mpfq_p_4_src_elt);
static inline
void mpfq_p_4_get_mpz(mpfq_p_4_dst_field, mpz_ptr, mpfq_p_4_src_elt);
...
#define mpfq_p_4_elt_ur_stride(k)	sizeof(mpfq_p_4_elt_ur)
static inline
...
int mpfq_p_4_vec_hamming_weight(mpfq_p_4_dst_field, mpfq_p_4_src_vec, unsigned int);
int mpfq_p_4_vec_find_first_set(mpfq_p_4_dst_field, mpfq_p_4_src_vec, unsigned int);
int mpfq_p_4_vec_simd_hamming_weight(mpfq_p_4_dst_field, mpfq_p_4_src_vec, unsigned int);
int mpfq_p_4_vec_simd_find_first_set(mpfq_p_4_dst_field, mpfq_p_4_src_vec, unsigned int);
...
#define mpfq_p_4_vec_elt_stride(k, n)	((n) * mpfq_p_4_elt_stride((k)))
/* *Mpfq::defaults::flatdata::code_for_vec_ur_elt_stride, Mpfq::gfp::elt, Mpfq::gfp */
#define mpfq_p_4_vec_ur_elt_stride(k, n)	((n) * mpfq_p_4_elt_ur_stride((k)))
...
#define mpfq_p_4_simd_groupsize(K)	1
static inline
int mpfq_p_4_simd_hamming_weight(mpfq_p_4_dst_field, mpfq_p_4_src_elt);
static inline
int mpfq_p_4_simd_find_first_set(mpfq_p_4_dst_field, mpfq_p_4_src_elt);
static inline
unsigned long mpfq_p_4_simd_get_ui_at(mpfq_p_4_dst_field, mpfq_p_4_src_elt, int);
static inline
void mpfq_p_4_simd_set_ui_at(mpfq_p_4_dst_field, mpfq_p_4_dst_elt, int, unsigned long);
static inline
void mpfq_p_4_simd_add_ui_at(mpfq_p_4_dst_field, mpfq_p_4_dst_elt, mpfq_p_4_src_elt, int, unsigned long);
static inline
void mpfq_p_4_simd_set_ui_all(mpfq_p_4_dst_field, mpfq_p_4_dst_elt, unsigned long);
void mpfq_p_4_add_dotprod(mpfq_p_4_dst_field, mpfq_p_4_dst_vec, mpfq_p_4_src_vec, mpfq_p_4_src_vec, unsigned int);
...
static inline
void mpfq_p_4_field_characteristic(mpfq_p_4_dst_field k, mpz_ptr z)
{
        mpz_set(z, k->p);
}
...
static inline
void mpfq_p_4_set_mpz(mpfq_p_4_dst_field k, mpfq_p_4_dst_elt r, mpz_srcptr z)
{
    if (z->_mp_size < 0) {
...
static inline
void mpfq_p_4_get_mpz(mpfq_p_4_dst_field k MAYBE_UNUSED, mpz_ptr z, mpfq_p_4_src_elt y)
{
    int i; 
    mpz_realloc2(z, 4*64);
    for (i = 0; i < 4; ++i)
...
{
    mpfq_copy(r, s, 4); mpfq_zero(r+4, 9-4);
}
...
{
            mpfq_p_4_dst_elt y = mpfq_p_4_vec_coeff_ptr(K, w, i);
            mpfq_p_4_set(K, y, x);
}
...
{
            mpfq_p_4_src_elt y = mpfq_p_4_vec_coeff_ptr_const(K, w, i);
            mpfq_p_4_set(K, x, y);
}
...
static inline
void mpfq_p_4_vec_scal_mul(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec w, mpfq_p_4_src_vec u, mpfq_p_4_src_elt c, unsigned int n)
{
        unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(K, u, i);
        mpfq_p_4_dst_elt y = mpfq_p_4_vec_coeff_ptr(K, w, i);
        mpfq_p_4_mul(K, y, x, c);
    }
}
...
void mpfq_p_4_vec_ur_set_vec(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec_ur w, mpfq_p_4_src_vec u, unsigned int n)
{
            ...
            for(i = 0; i < n; ++i) {
                mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(K, u, i);
                mpfq_p_4_dst_elt_ur y = mpfq_p_4_vec_ur_coeff_ptr(K, w, i);
                mpfq_p_4_elt_ur_set_elt(K, y, x);
            }
}
...
{
            mpfq_p_4_src_elt_ur y = mpfq_p_4_vec_ur_coeff_ptr_const(K, w, i);
            mpfq_p_4_elt_ur_set(K, x, y);
}
...
static inline
void mpfq_p_4_vec_scal_mul_ur(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec_ur w, mpfq_p_4_src_vec u, mpfq_p_4_src_elt c, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_p_4_src_elt x = mpfq_p_4_vec_coeff_ptr_const(K, u, i);
        mpfq_p_4_dst_elt_ur y = mpfq_p_4_vec_ur_coeff_ptr(K, w, i);
        mpfq_p_4_mul_ur(K, y, x, c);
    }
}
...
void mpfq_p_4_vec_reduce(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_vec w, mpfq_p_4_dst_vec_ur u, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_p_4_dst_elt_ur x = mpfq_p_4_vec_ur_coeff_ptr(K, u, i);
        mpfq_p_4_dst_elt y = mpfq_p_4_vec_coeff_ptr(K, w, i);
        mpfq_p_4_reduce(K, y, x);
    }
}
...
void mpfq_p_4_poly_xgcd(mpfq_p_4_dst_field k MAYBE_UNUSED, mpfq_p_4_dst_poly g, mpfq_p_4_dst_poly u0, mpfq_p_4_dst_poly v0, mpfq_p_4_src_poly a0, mpfq_p_4_src_poly b0)
{
    ...
    mpfq_p_4_elt c;
    mpfq_p_4_init(k,&c);
    mpfq_p_4_set_ui(k,c,0);        /* placate gcc */
...
static inline
int mpfq_p_4_simd_hamming_weight(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_src_elt p)
{
    return !mpfq_p_4_is_zero(K,p);
}

/* *simd_gfp::code_for_simd_find_first_set */
static inline
int mpfq_p_4_simd_find_first_set(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_src_elt p)
{
    return mpfq_p_4_simd_hamming_weight(K,p) - 1;
}

/* *simd_gfp::code_for_simd_get_ui_at */
static inline
unsigned long mpfq_p_4_simd_get_ui_at(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_src_elt p, int k MAYBE_UNUSED)
{
    return mpfq_p_4_get_ui(K,p);
}

/* *simd_gfp::code_for_simd_set_ui_at */
static inline
void mpfq_p_4_simd_set_ui_at(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_elt p, int k MAYBE_UNUSED, unsigned long v)
{
...
static inline
void mpfq_p_4_simd_add_ui_at(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_elt p, mpfq_p_4_src_elt p0, int k MAYBE_UNUSED, unsigned long v)
{
    mpfq_p_4_add_ui(K,p,p0,v);
}

/* *simd_gfp::code_for_simd_set_ui_all */
static inline
void mpfq_p_4_simd_set_ui_all(mpfq_p_4_dst_field K MAYBE_UNUSED, mpfq_p_4_dst_elt p, unsigned long v)
{
    mpfq_p_4_set_ui(K,p,v);
}
