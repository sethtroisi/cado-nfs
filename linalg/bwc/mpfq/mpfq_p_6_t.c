...
void mpfq_p_6_p_6_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_p_6_dst_vec xw, mpfq_p_6_src_vec xu1, mpfq_p_6_src_vec xu0, unsigned int n)
{
    mpfq_p_6_p_6_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}

/* *simd_gfp::code_for_member_template_dotprod */
void mpfq_p_6_p_6_dotprod(mpfq_p_6_dst_field K0 MAYBE_UNUSED, mpfq_p_6_dst_field K1 MAYBE_UNUSED, mpfq_p_6_dst_vec xw, mpfq_p_6_src_vec xu1, mpfq_p_6_src_vec xu0, unsigned int n)
{
        mpfq_p_6_elt_ur s,t;
        mpfq_p_6_elt_ur_init(K0, &s);
        mpfq_p_6_elt_ur_init(K0, &t);
        mpfq_p_6_elt_ur_set_zero(K0, s);
