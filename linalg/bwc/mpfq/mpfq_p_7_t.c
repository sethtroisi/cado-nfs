...
void mpfq_p_7_p_7_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_p_7_dst_vec xw, mpfq_p_7_src_vec xu1, mpfq_p_7_src_vec xu0, unsigned int n)
{
    mpfq_p_7_p_7_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}

/* *simd_gfp::code_for_member_template_dotprod */
void mpfq_p_7_p_7_dotprod(mpfq_p_7_dst_field K0 MAYBE_UNUSED, mpfq_p_7_dst_field K1 MAYBE_UNUSED, mpfq_p_7_dst_vec xw, mpfq_p_7_src_vec xu1, mpfq_p_7_src_vec xu0, unsigned int n)
{
        mpfq_p_7_elt_ur s,t;
        mpfq_p_7_elt_ur_init(K0, &s);
        mpfq_p_7_elt_ur_init(K0, &t);
        mpfq_p_7_elt_ur_set_zero(K0, s);
...
/* Mpfq::engine::handler::create_code */
void mpfq_p_7_p_7_wrapper_addmul_tiny(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_p_7_dst_vec w, mpfq_p_7_src_vec u, mpfq_p_7_dst_vec v, unsigned int n)
{
    mpfq_p_7_p_7_addmul_tiny(K->obj, L->obj, w, u, v, n);
}

/* *simd_gfp::code_for_member_template_addmul_tiny */
void mpfq_p_7_p_7_addmul_tiny(mpfq_p_7_dst_field K MAYBE_UNUSED, mpfq_p_7_dst_field L MAYBE_UNUSED, mpfq_p_7_dst_vec w, mpfq_p_7_src_vec u, mpfq_p_7_dst_vec v, unsigned int n)
{
        mpfq_p_7_elt s;
        mpfq_p_7_init(K, &s);
        for(unsigned int i = 0 ; i < n ; i++) {
