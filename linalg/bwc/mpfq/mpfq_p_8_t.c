...
void mpfq_p_8_p_8_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_p_8_dst_vec xw, mpfq_p_8_src_vec xu1, mpfq_p_8_src_vec xu0, unsigned int n)
{
    mpfq_p_8_p_8_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_8 */

#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
/* *simd_gfp::code_for_member_template_add_dotprod */
void mpfq_p_8_p_8_add_dotprod(mpfq_p_8_dst_field K0 MAYBE_UNUSED, mpfq_p_8_dst_field K1 MAYBE_UNUSED, mpfq_p_8_dst_vec xw, mpfq_p_8_src_vec xu1, mpfq_p_8_src_vec xu0, unsigned int n)
{
        mpfq_p_8_elt_ur s,t;
        mpfq_p_8_elt_ur_init(K0, &s);
        mpfq_p_8_elt_ur_init(K0, &t);
        mpfq_p_8_elt_ur_set_elt(K0, s, xw[0]);
...
#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
/* Mpfq::engine::handler::create_code */
void mpfq_p_8_p_8_wrapper_addmul_tiny(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_p_8_dst_vec w, mpfq_p_8_src_vec u, mpfq_p_8_src_vec v, unsigned int n)
{
    mpfq_p_8_p_8_addmul_tiny(K->obj, L->obj, w, u, v, n);
}
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_8 */

#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
/* *simd_gfp::code_for_member_template_addmul_tiny */
void mpfq_p_8_p_8_addmul_tiny(mpfq_p_8_dst_field K MAYBE_UNUSED, mpfq_p_8_dst_field L MAYBE_UNUSED, mpfq_p_8_dst_vec w, mpfq_p_8_src_vec u, mpfq_p_8_src_vec v, unsigned int n)
{
        mpfq_p_8_elt s;
        mpfq_p_8_init(K, &s);
        for(unsigned int i = 0 ; i < n ; i++) {
...
#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
/* Mpfq::engine::handler::create_code */
void mpfq_p_8_p_8_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_p_8_dst_vec w, mpfq_p_8_src_vec u)
{
    mpfq_p_8_p_8_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_8 */
