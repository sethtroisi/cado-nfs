...
#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
/* Mpfq::engine::handler::create_code */
void mpfq_p_8_p_8_wrapper_addmul_tiny(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_p_8_dst_vec w, mpfq_p_8_src_vec u, mpfq_p_8_dst_vec v, unsigned int n)
{
