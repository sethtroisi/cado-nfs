...
void mpfq_p_8_p_8_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_p_8_dst_vec xw, mpfq_p_8_src_vec xu1, mpfq_p_8_src_vec xu0, unsigned int n)
{
    mpfq_p_8_p_8_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
