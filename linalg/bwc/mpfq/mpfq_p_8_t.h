...
#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
void mpfq_p_8_p_8_wrapper_addmul_tiny(mpfq_vbase_ptr, mpfq_vbase_ptr, mpfq_p_8_dst_vec, mpfq_p_8_src_vec, mpfq_p_8_dst_vec, unsigned int);
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_8 */

#ifdef COMPILE_MPFQ_PRIME_FIELD_p_8
void mpfq_p_8_p_8_addmul_tiny(mpfq_p_8_dst_field, mpfq_p_8_dst_field, mpfq_p_8_dst_vec, mpfq_p_8_src_vec, mpfq_p_8_dst_vec, unsigned int);
#endif /* COMPILE_MPFQ_PRIME_FIELD_p_8 */
