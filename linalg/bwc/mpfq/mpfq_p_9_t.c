...
#ifdef COMPILE_MPFQ_PRIME_FIELD_p_9
/* Mpfq::engine::handler::create_code */
void mpfq_p_9_p_9_wrapper_addmul_tiny(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_p_9_dst_vec w, mpfq_p_9_src_vec u, mpfq_p_9_src_vec v, unsigned int n)
{
...
void mpfq_p_9_p_9_addmul_tiny(mpfq_p_9_dst_field K MAYBE_UNUSED, mpfq_p_9_dst_field L MAYBE_UNUSED, mpfq_p_9_dst_vec w, mpfq_p_9_src_vec u, mpfq_p_9_src_vec v, unsigned int n)
{
        mpfq_p_9_elt s;
        mpfq_p_9_init(K, &s);
        for(unsigned int i = 0 ; i < n ; i++) {
