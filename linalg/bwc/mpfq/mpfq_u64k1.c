...
void mpfq_u64k1_mpi_op_inner(void * invec, void * inoutvec, int * len, MPI_Datatype * datatype)
{
    int got_it;
...
static /* *Mpfq::defaults::mpi_flat::code_for_mpi_ops_init */
void mpfq_u64k1_mpi_op_inner_ur(void * invec, void * inoutvec, int * len, MPI_Datatype * datatype)
{
    int got_it;
    mpfq_u64k1_dst_field K;
    MPI_Type_get_attr(*datatype, mpfq_u64k1_impl_mpi_attr, (void*) &K, &got_it);
