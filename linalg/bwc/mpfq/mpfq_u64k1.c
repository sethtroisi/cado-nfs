...
static void mpfq_u64k1_wrapper_vec_scal_mul(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k1_dst_vec w MAYBE_UNUSED, mpfq_u64k1_src_vec u MAYBE_UNUSED, mpfq_u64k1_src_elt x MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_u64k1_vec_scal_mul(vbase->obj, w, u, x, n);
}
