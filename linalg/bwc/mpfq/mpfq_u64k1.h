...
void mpfq_u64k1_field_specify(mpfq_u64k1_dst_field, unsigned long, const void *);
...
#define mpfq_u64k1_elt_stride(k)	sizeof(mpfq_u64k1_elt)
...
static inline
void mpfq_u64k1_random2(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt, gmp_randstate_t);
...
static inline
void mpfq_u64k1_mul(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt, mpfq_u64k1_src_elt, mpfq_u64k1_src_elt);
static inline
int mpfq_u64k1_inv(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt, mpfq_u64k1_src_elt);
...
#define mpfq_u64k1_elt_ur_stride(k)	sizeof(mpfq_u64k1_elt_ur)
static inline
...
static inline
void mpfq_u64k1_mul_ur(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt_ur, mpfq_u64k1_src_elt, mpfq_u64k1_src_elt);
static inline
void mpfq_u64k1_reduce(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt, mpfq_u64k1_dst_elt_ur);
...
static inline
void mpfq_u64k1_vec_scal_mul(mpfq_u64k1_dst_field, mpfq_u64k1_dst_vec, mpfq_u64k1_src_vec, mpfq_u64k1_src_elt, unsigned int);
void mpfq_u64k1_vec_random(mpfq_u64k1_dst_field, mpfq_u64k1_dst_vec, unsigned int, gmp_randstate_t);
void mpfq_u64k1_vec_random2(mpfq_u64k1_dst_field, mpfq_u64k1_dst_vec, unsigned int, gmp_randstate_t);
...
int mpfq_u64k1_vec_hamming_weight(mpfq_u64k1_dst_field, mpfq_u64k1_src_vec, unsigned int);
int mpfq_u64k1_vec_find_first_set(mpfq_u64k1_dst_field, mpfq_u64k1_src_vec, unsigned int);
int mpfq_u64k1_vec_simd_hamming_weight(mpfq_u64k1_dst_field, mpfq_u64k1_src_vec, unsigned int);
int mpfq_u64k1_vec_simd_find_first_set(mpfq_u64k1_dst_field, mpfq_u64k1_src_vec, unsigned int);
...
static inline
void mpfq_u64k1_vec_scal_mul_ur(mpfq_u64k1_dst_field, mpfq_u64k1_dst_vec_ur, mpfq_u64k1_src_vec, mpfq_u64k1_src_elt, unsigned int);
static inline
void mpfq_u64k1_vec_reduce(mpfq_u64k1_dst_field, mpfq_u64k1_dst_vec, mpfq_u64k1_dst_vec_ur, unsigned int);
static inline
...
#define mpfq_u64k1_vec_elt_stride(k, n)	((n) * mpfq_u64k1_elt_stride((k)))
/* *Mpfq::defaults::flatdata::code_for_vec_ur_elt_stride, simd_flat, simd_char2 */
#define mpfq_u64k1_vec_ur_elt_stride(k, n)	((n) * mpfq_u64k1_elt_ur_stride((k)))

/* Polynomial functions */

/* Functions related to SIMD operation */
/* *simd_u64k::code_for_simd_groupsize */
#define mpfq_u64k1_simd_groupsize(K)	64
static inline
int mpfq_u64k1_simd_hamming_weight(mpfq_u64k1_dst_field, mpfq_u64k1_src_elt);
static inline
int mpfq_u64k1_simd_find_first_set(mpfq_u64k1_dst_field, mpfq_u64k1_src_elt);
static inline
unsigned long mpfq_u64k1_simd_get_ui_at(mpfq_u64k1_dst_field, mpfq_u64k1_src_elt, int);
static inline
void mpfq_u64k1_simd_set_ui_at(mpfq_u64k1_dst_field, mpfq_u64k1_dst_elt, int, unsigned long);
static inline
...
void mpfq_u64k1_random(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt r, gmp_randstate_t state)
{
        ...
        ugly->_mp_alloc = sizeof(mpfq_u64k1_elt) / sizeof(mp_limb_t);
        ugly->_mp_size = sizeof(mpfq_u64k1_elt) / sizeof(mp_limb_t);
        mpz_urandomb(ugly, state, mpfq_u64k1_simd_groupsize(K));
}

/* *simd_flat::code_for_random2, simd_char2 */
static inline
void mpfq_u64k1_random2(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt r, gmp_randstate_t state)
{
        mpz_t ugly;
        ugly->_mp_d = (mp_limb_t *) r;
        ugly->_mp_alloc = sizeof(mpfq_u64k1_elt) / sizeof(mp_limb_t);
        ugly->_mp_size = sizeof(mpfq_u64k1_elt) / sizeof(mp_limb_t);
        mpz_rrandomb(ugly, state, mpfq_u64k1_simd_groupsize(K));
}
...
static inline
void mpfq_u64k1_mul(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt r, mpfq_u64k1_src_elt s1, mpfq_u64k1_src_elt s2)
{
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k1_elt)/sizeof(*r) ; i++) {
            r[i] = s1[i] & s2[i];
        }
...
static inline
int mpfq_u64k1_inv(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt r, mpfq_u64k1_src_elt s)
{
        int rc = 0;
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k1_elt)/sizeof(*r) ; i++) {
            r[i] = s[i];
...
static inline
void mpfq_u64k1_mul_ur(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt_ur r, mpfq_u64k1_src_elt s1, mpfq_u64k1_src_elt s2)
{
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k1_elt)/sizeof(*r) ; i++) {
            r[i] = s1[i] & s2[i];
        }
...
static inline
void mpfq_u64k1_reduce(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt r, mpfq_u64k1_dst_elt_ur s)
{
    mpfq_copy((mp_limb_t*)r,(const mp_limb_t*)s,sizeof(mpfq_u64k1_elt)/sizeof(mp_limb_t));
}
...
{
            mpfq_u64k1_dst_elt y = mpfq_u64k1_vec_coeff_ptr(K, w, i);
            mpfq_u64k1_set(K, y, x);
}
...
{
            mpfq_u64k1_src_elt y = mpfq_u64k1_vec_coeff_ptr_const(K, w, i);
            mpfq_u64k1_set(K, x, y);
}
...
static inline
void mpfq_u64k1_vec_scal_mul(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_vec w, mpfq_u64k1_src_vec u, mpfq_u64k1_src_elt c, unsigned int n)
{
        unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_u64k1_src_elt x = mpfq_u64k1_vec_coeff_ptr_const(K, u, i);
        mpfq_u64k1_dst_elt y = mpfq_u64k1_vec_coeff_ptr(K, w, i);
        mpfq_u64k1_mul(K, y, x, c);
    }
}
...
void mpfq_u64k1_vec_ur_set_vec(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_vec_ur w, mpfq_u64k1_src_vec u, unsigned int n)
{
            ...
            for(i = 0; i < n; ++i) {
                mpfq_u64k1_src_elt x = mpfq_u64k1_vec_coeff_ptr_const(K, u, i);
                mpfq_u64k1_dst_elt_ur y = mpfq_u64k1_vec_ur_coeff_ptr(K, w, i);
                mpfq_u64k1_elt_ur_set_elt(K, y, x);
            }
}
...
{
            mpfq_u64k1_src_elt_ur y = mpfq_u64k1_vec_ur_coeff_ptr_const(K, w, i);
            mpfq_u64k1_elt_ur_set(K, x, y);
}
...
static inline
void mpfq_u64k1_vec_scal_mul_ur(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_vec_ur w, mpfq_u64k1_src_vec u, mpfq_u64k1_src_elt c, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_u64k1_src_elt x = mpfq_u64k1_vec_coeff_ptr_const(K, u, i);
        mpfq_u64k1_dst_elt_ur y = mpfq_u64k1_vec_ur_coeff_ptr(K, w, i);
        mpfq_u64k1_mul_ur(K, y, x, c);
    }
}

/* *Mpfq::defaults::vec::mul::code_for_vec_reduce, Mpfq::defaults::vec */
static inline
void mpfq_u64k1_vec_reduce(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_vec w, mpfq_u64k1_dst_vec_ur u, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i++) {
        mpfq_u64k1_dst_elt_ur x = mpfq_u64k1_vec_ur_coeff_ptr(K, u, i);
        mpfq_u64k1_dst_elt y = mpfq_u64k1_vec_coeff_ptr(K, w, i);
        mpfq_u64k1_reduce(K, y, x);
    }
}
...
static inline
int mpfq_u64k1_simd_hamming_weight(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_src_elt p)
{
        int w = 0;
#if GNUC_VERSION_ATLEAST(3,4,0)
        unsigned long * xp = (unsigned long *) p;
        assert(mpfq_u64k1_elt_stride(K) % sizeof(unsigned long) == 0);
        for(size_t b = 0 ; b < mpfq_u64k1_elt_stride(K) / sizeof(unsigned long) ; b++) {
            w += __builtin_popcountl(xp[b]);
        }
#else
        int tab[16] = { 0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4 };
        uint8_t * xp = (uint8_t *) p;
        for(size_t b = 0 ; b < mpfq_u64k1_elt_stride(K) ; b++) {
...
int mpfq_u64k1_simd_find_first_set(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_src_elt p)
{
        ...
        for(size_t b = 0 ; b < bmax ; b++, f+=g) {
            ...
            for(size_t c = 0 ; c < sizeof(mpfq_u64k1_elt) / sizeof(unsigned long) ; c++, f += 64) {
                if (!xp[c]) continue;
            ...
            for(size_t c = 0 ; c < sizeof(mpfq_u64k1_elt) ; c++, f += 8) {
                if (!xp[c]) continue;
...
static inline
unsigned long mpfq_u64k1_simd_get_ui_at(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_src_elt p, int k)
{
...
static inline
void mpfq_u64k1_simd_set_ui_at(mpfq_u64k1_dst_field K MAYBE_UNUSED, mpfq_u64k1_dst_elt p, int k, unsigned long v)
{
        assert(k < mpfq_u64k1_simd_groupsize(K));
        uint64_t * xp = (uint64_t *) p;
        uint64_t mask = ((uint64_t)1) << (k%64);
