...
void mpfq_u64k3_m128_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_m128_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    mpfq_u64k3_m128_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_m128 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_m128
/* *simd_dotprod::code_for_member_template_add_dotprod */
void mpfq_u64k3_m128_add_dotprod(mpfq_u64k3_dst_field K0 MAYBE_UNUSED, mpfq_m128_dst_field K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_m128_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
    add_dotprod_64K_128(w,u0,u1,n,3);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_m128 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k1
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k1_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k1_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    mpfq_u64k3_u64k1_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k1 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k1
/* *simd_dotprod::code_for_member_template_add_dotprod */
void mpfq_u64k3_u64k1_add_dotprod(mpfq_u64k3_dst_field K0 MAYBE_UNUSED, mpfq_u64k1_dst_field K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k1_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
    add_dotprod_64K_64(w,u0,u1,n,3);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k1 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k2
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k2_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k2_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    mpfq_u64k3_u64k2_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k2 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k2
/* *simd_dotprod::code_for_member_template_add_dotprod */
void mpfq_u64k3_u64k2_add_dotprod(mpfq_u64k3_dst_field K0 MAYBE_UNUSED, mpfq_u64k2_dst_field K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k2_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
...
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k3_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k3_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    mpfq_u64k3_u64k3_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k3 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k3
/* *simd_dotprod::code_for_member_template_add_dotprod */
void mpfq_u64k3_u64k3_add_dotprod(mpfq_u64k3_dst_field K0 MAYBE_UNUSED, mpfq_u64k3_dst_field K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k3_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
...
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k4_wrapper_add_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k4_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    mpfq_u64k3_u64k4_add_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k4 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k4
/* *simd_dotprod::code_for_member_template_add_dotprod */
void mpfq_u64k3_u64k4_add_dotprod(mpfq_u64k3_dst_field K0 MAYBE_UNUSED, mpfq_u64k4_dst_field K1 MAYBE_UNUSED, mpfq_u64k3_dst_vec xw, mpfq_u64k4_src_vec xu1, mpfq_u64k3_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
    add_dotprod_64K_64L(w,u1,u0,n,4,3);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k4 */
...
#ifdef COMPILE_MPFQ_BINARY_FIELD_m128
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_m128_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_m128_src_vec u)
{
    mpfq_u64k3_m128_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_m128 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_m128
/* *simd_dotprod::code_for_member_template_transpose */
void mpfq_u64k3_m128_transpose(mpfq_u64k3_dst_field K MAYBE_UNUSED, mpfq_m128_dst_field L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_m128_src_vec u)
{
...
#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k1
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k1_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_u64k1_src_vec u)
{
    mpfq_u64k3_u64k1_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k1 */
...
#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k2
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k2_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_u64k2_src_vec u)
{
    mpfq_u64k3_u64k2_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k2 */
...
#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k3
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k3_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_u64k3_src_vec u)
{
    mpfq_u64k3_u64k3_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k3 */
...
#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k4
/* Mpfq::engine::handler::create_code */
void mpfq_u64k3_u64k4_wrapper_transpose(mpfq_vbase_ptr K MAYBE_UNUSED, mpfq_vbase_ptr L MAYBE_UNUSED, mpfq_u64k3_dst_vec w, mpfq_u64k4_src_vec u)
{
    mpfq_u64k3_u64k4_transpose(K->obj, L->obj, w, u);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k4 */
