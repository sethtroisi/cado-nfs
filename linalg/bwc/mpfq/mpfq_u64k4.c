...
void mpfq_u64k4_add_dotprod(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k4_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
...
static void mpfq_u64k4_wrapper_add_dotprod(mpfq_vbase_ptr, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, mpfq_u64k4_src_vec, unsigned int);
static void mpfq_u64k4_wrapper_add_dotprod(mpfq_vbase_ptr vbase MAYBE_UNUSED, mpfq_u64k4_dst_vec xw MAYBE_UNUSED, mpfq_u64k4_src_vec xu1 MAYBE_UNUSED, mpfq_u64k4_src_vec xu0 MAYBE_UNUSED, unsigned int n MAYBE_UNUSED)
{
    mpfq_u64k4_add_dotprod(vbase->obj, xw, xu1, xu0, n);
}
...
void mpfq_u64k4_oo_field_init(mpfq_vbase_ptr vbase)
{
    ...
    vbase->add_dotprod = (void (*) (mpfq_vbase_ptr, void *, const void *, const void *, unsigned int)) mpfq_u64k4_wrapper_add_dotprod;
