...
#define mpfq_u64k4_vec_scan(K, w, n)	mpfq_u64k4_vec_fscan(K,stdout,w,n)
...
#define mpfq_u64k4_vec_elt_stride(K, n)	((n)*sizeof(mpfq_u64k4_elt))
/* *Mpfq::defaults::flatdata::code_for_vec_ur_elt_stride, simd_flat */
#define mpfq_u64k4_vec_ur_elt_stride(K, n)	((n)*sizeof(mpfq_u64k4_elt_ur))

/* Polynomial functions */

/* Functions related to SIMD operation */
/* *simd_u64k::code_for_groupsize */
#define mpfq_u64k4_groupsize(K)	256
/* *trivialities::code_for_offset */
#define mpfq_u64k4_offset(K, n)	n /* TO BE DEPRECATED */
/* *trivialities::code_for_stride */
#define mpfq_u64k4_stride(K)	1 /* TO BE DEPRECATED */
static inline
void mpfq_u64k4_set_ui_at(mpfq_u64k4_dst_field, mpfq_u64k4_dst_elt, int, unsigned long);
static inline
void mpfq_u64k4_set_ui_all(mpfq_u64k4_dst_field, mpfq_u64k4_dst_elt, unsigned long);
static inline
void mpfq_u64k4_elt_ur_set_ui_at(mpfq_u64k4_dst_field, mpfq_u64k4_dst_elt, int, unsigned long);
static inline
void mpfq_u64k4_elt_ur_set_ui_all(mpfq_u64k4_dst_field, mpfq_u64k4_dst_elt, unsigned long);
void mpfq_u64k4_dotprod(mpfq_u64k4_dst_field, mpfq_u64k4_dst_vec, mpfq_u64k4_src_vec, mpfq_u64k4_src_vec, unsigned int);

/* Member templates related to SIMD operation */

/* MPI interface */
void mpfq_u64k4_mpi_ops_init(mpfq_u64k4_dst_field);
MPI_Datatype mpfq_u64k4_mpi_datatype(mpfq_u64k4_dst_field);
MPI_Datatype mpfq_u64k4_mpi_datatype_ur(mpfq_u64k4_dst_field);
MPI_Op mpfq_u64k4_mpi_addition_op(mpfq_u64k4_dst_field);
MPI_Op mpfq_u64k4_mpi_addition_op_ur(mpfq_u64k4_dst_field);
void mpfq_u64k4_mpi_ops_clear(mpfq_u64k4_dst_field);
...
{
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k4_elt) ; i++) {
...
static inline
void mpfq_u64k4_vec_random(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_vec w, unsigned int n, gmp_randstate_t state)
{
    unsigned int i;
    for(i = 0; i < n; ++i)
        mpfq_u64k4_random(K, w[i], state);
}

/* *Mpfq::defaults::vec::getset::code_for_vec_cmp, Mpfq::defaults::vec */
static inline
int mpfq_u64k4_vec_cmp(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_src_vec u, mpfq_u64k4_src_vec v, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; ++i) {
        int ret = mpfq_u64k4_cmp(K, u[i], v[i]);
        if (ret != 0)
            return ret;
    }
    return 0;
...
static inline
int mpfq_u64k4_vec_is_zero(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_src_vec r, unsigned int n)
{
    unsigned int i;
    for(i = 0 ; i < n ; i+=1) {
        if (!mpfq_u64k4_is_zero(K,r[i])) return 0;
    }
    return 1;
}
...
void mpfq_u64k4_vec_ur_set_vec(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_vec_ur w, mpfq_u64k4_src_vec u, unsigned int n)
{
    unsigned int i;
    for(i = 0; i < n; i+=1)
        mpfq_u64k4_elt_ur_set_elt(K, w[i], u[i]);
}
...
static inline
void mpfq_u64k4_set_ui_at(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_elt p, int k, unsigned long v)
{
        assert(k < mpfq_u64k4_groupsize(K));
...
static inline
void mpfq_u64k4_set_ui_all(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_elt r, unsigned long v)
{
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k4_elt)/sizeof(*r) ; i++) {
            r[i] = ~v;
        }
...
static inline
void mpfq_u64k4_elt_ur_set_ui_at(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_elt p, int k, unsigned long v)
{
        assert(k < mpfq_u64k4_groupsize(K));
        uint64_t * xp = (uint64_t *) p;
        uint64_t mask = ((uint64_t)1) << (k%64);
...
static inline
void mpfq_u64k4_elt_ur_set_ui_all(mpfq_u64k4_dst_field K MAYBE_UNUSED, mpfq_u64k4_dst_elt r, unsigned long v)
{
        for(unsigned int i = 0 ; i < sizeof(mpfq_u64k4_elt)/sizeof(*r) ; i++) {
            r[i] = ~v;
        }
