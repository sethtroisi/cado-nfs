...
void mpfq_u64k4_m128_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_m128_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    mpfq_u64k4_m128_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_m128 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_m128
/* *simd_dotprod::code_for_member_template_dotprod */
void mpfq_u64k4_m128_dotprod(mpfq_u64k4_dst_field K0 MAYBE_UNUSED, mpfq_m128_dst_field K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_m128_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
...
/* Mpfq::engine::handler::create_code */
void mpfq_u64k4_u64k1_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k1_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    mpfq_u64k4_u64k1_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
...
/* Mpfq::engine::handler::create_code */
void mpfq_u64k4_u64k2_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k2_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    mpfq_u64k4_u64k2_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
...
/* Mpfq::engine::handler::create_code */
void mpfq_u64k4_u64k3_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k3_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    mpfq_u64k4_u64k3_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k3 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k3
/* *simd_dotprod::code_for_member_template_dotprod */
void mpfq_u64k4_u64k3_dotprod(mpfq_u64k4_dst_field K0 MAYBE_UNUSED, mpfq_u64k3_dst_field K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k3_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    uint64_t * w = (uint64_t *) xw;
    const uint64_t * u0 = (const uint64_t *) xu0;
    const uint64_t * u1 = (const uint64_t *) xu1;
    dotprod_64K_64L(w,u1,u0,n,3,4);
}
#endif /* COMPILE_MPFQ_BINARY_FIELD_u64k3 */

#ifdef COMPILE_MPFQ_BINARY_FIELD_u64k4
/* Mpfq::engine::handler::create_code */
void mpfq_u64k4_u64k4_wrapper_dotprod(mpfq_vbase_ptr K0 MAYBE_UNUSED, mpfq_vbase_ptr K1 MAYBE_UNUSED, mpfq_u64k4_dst_vec xw, mpfq_u64k4_src_vec xu1, mpfq_u64k4_src_vec xu0, unsigned int n)
{
    mpfq_u64k4_u64k4_dotprod(K0->obj, K1->obj, xw, xu1, xu0, n);
}
