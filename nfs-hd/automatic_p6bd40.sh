...
sleep 0.5
./special-q_sieve -H 6,6,6 -fbb 524288,524288 -thresh 65,65 -poly p6bd40.poly -lpb 23,23 -q_side 1 -fb sieve_base_p6bd40 -q_range 524341,2354820 -out sieve_524341_2354820 -err /dev/null -gal 6
echo
