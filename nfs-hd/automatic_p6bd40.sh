...
sleep 0.5
./special-q_sieve -H 7,7,7 -fbb 1482911,1482911 -thresh 55,55 -poly p6bd40.poly -lpb 25,25 -q_side 1 -fb sieve_base_p6bd40 -q_range 1482937,2515517 -out sieve_1482937_2515517 -err /dev/null -gal 6
echo
...
cd ../../build/`hostname`/nfs-hd/
grep -v "#" sieve_1482937_2515517 > relations.raw
