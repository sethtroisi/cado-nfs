...
// This stores in I the ideal of O generated by gen (supposed to be in a-b*alpha form)
void make_principal_ideal(mpq_mat_ptr I, mpq_mat_ptr G, mpz_poly_ptr g, mpz_mat_ptr gen)
{
    ...
    //cxx_mpz_mat T;
    //mpq_hnf_backend_rev(I,T);
    hnf_magma_style(I,I);
}

// Let O be the order generated by elements of G.
// This stores in I the ideal of O generated by row of gen (supposed to be in a-b*alpha form)
void make_ideal(mpq_mat_ptr I, mpq_mat_ptr G, mpz_poly_ptr g, mpz_mat_ptr gen)
{
...
int valuation_of_ideal_at_prime_ideal(mpq_mat_ptr G, mpz_poly_ptr g, mpq_mat_ptr J, mpq_mat_ptr I, int e, unsigned int p)
{
    ...
    do{
        ...
        //printf("h_times_MJ_G :\n"); mpq_mat_fprint(stdout, h_times_MJ_G); printf("\n");
...
{				/*{{{ */
    ...
    printf("valuation of ideal \n");
    mpq_mat_fprint(stdout, J); printf("\n");
    printf("on ideal \n");
    mpq_mat_fprint(stdout, I); printf("\n");
