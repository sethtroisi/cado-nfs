...
void valuation_helper_for_ideal(mpq_mat_ptr h, mpq_mat_srcptr G, mpz_poly_srcptr g, mpq_mat_srcptr I, unsigned int p)
{
...
{				/*{{{ */
    ...
    printf("on ideal \n");
    mpq_mat_fprint(stdout, I); printf("\n");
    int val = valuation_of_ideal_by_gens_at_prime_ideal(D,g,gen,I,mul_I,p);
    printf("is %d\n", val);
    mpq_mat_clear(J);
