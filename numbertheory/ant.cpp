...
void valuation_helper_for_ideal(mpq_mat_ptr h, mpq_mat_srcptr G, mpz_poly_srcptr g, mpq_mat_srcptr I, const unsigned int p)
{
...
// Takes G, basis of one order, in alpha^ basis, and I, basis of an ideal, in alpha^ basis
