#ifndef OPS_POLY_SCHOOLBOOK_HPP_
#define OPS_POLY_SCHOOLBOOK_HPP_
...
public:
	typedef ops_poly_scbk self;
	typedef mp_limb_t * mat_bb;
	typedef mp_limb_t * mat_mb;
...
#endif	/* OPS_POLY_SCHOOLBOOK_HPP_ */
