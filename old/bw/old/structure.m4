...
#define $4col_alloc_m(x)	(x=(bw_$4col_r) mymalloc($4col_size*sizeof(mp_limb_t)))
...
#endif	/* HARDCODE_PARAMS */
#define $1poly_alloc_m(x,d)	(x=(bw_$1poly_r) mymalloc($3 * ((d)+1) * sizeof(mp_limb_t)))
