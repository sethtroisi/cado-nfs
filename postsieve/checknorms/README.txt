...
This is a slightly revamped variant of Paul's checknorms program. It has been
modified to use TIFA instead of ECM. Usage is unchanged:
...
To compile it, you will obviously need to compile TIFA. The provided Makefile
...
Setting the preprocessor symbol DEBUG to 1 (line 30 of checknorms.c) will change
the behavior of the program to prompt for user input before reading a relation
and will print a lots of messages.
