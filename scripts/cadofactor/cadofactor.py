...
if __name__ == '__main__':
    ...
    parser.add_argument("--filelog", help="Log file logging level, e.g., INFO/COMMAND/DEBUG", default="DEBUG", metavar="LEVEL")
    ...
    logger.addHandler(cadologger.FileHandler(filename = logfilename, lvl = filelvl))
