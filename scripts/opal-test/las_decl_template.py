...
rlambda = Parameter(kind='real', default=rlambda_def, bound=(rlambda_min, rlambda_max), name='rlambda', description='Sieve survivor threshold')
alambda = Parameter(kind='real', default=alambda_def, bound=(alambda_min, alambda_max), name='alambda', description='Sieve survivor threshold')
