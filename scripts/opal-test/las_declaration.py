...
alambda = Parameter(kind='real', default=1.1, bound=(0.9, 1.3), name='alambda', description='Sieve survivor threshold')
rlambda = Parameter(kind='real', default=1.1, bound=(0.9, 1.3), name='rlambda', description='Sieve survivor threshold')
alim = Parameter(kind='integer', default=600000, bound=(50000, 1000000), name='alim', description='Factor base bound, algebraic side')
rlim = Parameter(kind='integer', default=600000, bound=(30000, 1000000), name='rlim', description='Factor base bound, rational side')
lpba = Parameter(kind='integer', default=22, bound=(20, 25), name='lpba', description='Large prime bound, algebraic side')
lpbr = Parameter(kind='integer', default=22, bound=(20, 25), name='lpbr', description='Large prime bound, rational side')
