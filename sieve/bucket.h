...
class bucket_primes_t : public bucket_single<bucket_update_t<1, primehint_t> > {
  typedef bucket_single<bucket_update_t<1, primehint_t> > super;
public:  
  bucket_primes_t (const size_t size) : super(size){}
  ~bucket_primes_t(){}
  void purge (const bucket_array_t<bucket_update_t<1, shorthint_t> > &BA, 
...
class bucket_array_complete : public bucket_single<bucket_update_t<1, longhint_t> > {
    typedef bucket_single<bucket_update_t<1, longhint_t> > super;
public:  
  bucket_array_complete (const size_t size) : super(size){}
  ~bucket_array_complete(){}
  void purge (const bucket_array_t<bucket_update_t<1, shorthint_t> > &BA, int i, const unsigned char *S);
};
