...
static inline void xToAB(int64_t *a, uint64_t *b, const uint64_t x, sieve_info_srcptr si);
...
int ABTox(uint64_t *x, const int64_t a, const uint64_t b, sieve_info_srcptr si);
...
static inline void xToABmpz(mpz_t a, mpz_t b,
        const uint64_t x, sieve_info_srcptr si)
{
    int i, j;
    uint32_t I = si->I;
...
static inline void NxToABmpz(mpz_t a, mpz_t b,
        const unsigned int N, const unsigned int x, sieve_info_srcptr si)
{
