...
extern void small_sieve_info(sieve_info_srcptr si, const char * what, int side, small_sieve_data_t * r);
...
extern void small_sieve_init(small_sieve_data_t *ssd, const factorbase_degn_t *fb,
