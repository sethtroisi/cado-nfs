...
declare_usage(param_list pl)
{
  ...
  param_list_decl_usage (pl, "lb",  "to begin the benchmark with prime numbers of 'lb' bits.");
  param_list_decl_usage (pl, "p",   "(switch) to bench the probabilities.");
  param_list_decl_usage (pl, "t",   "(switch) to bench the times.");
  param_list_decl_usage (pl, "in",  "to locate the file which contains our factoring methods.");
  param_list_decl_usage (pl, "out", "to locate the file which contains our benchmark.");
}
