...
double
compute_time_strategy_r (tabular_decomp_t* init_tab, strategy_t* strat, int side, 
			 double proba_failed_facto_other_side);
...
tabular_strategy_t*
generate_strategies_oneside (fm_t* zero, tabular_fm_t* pm1, tabular_fm_t* pp1, 
...
tabular_strategy_t*
convert_tab_strategy_to_tab_point (tabular_point_t* t, tabular_strategy_t* init);
