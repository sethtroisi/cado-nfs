...
tabular_fm_t*
strategy_get_tab_fm (strategy_t* t)
{
  return t->tab_fm;
}

double
strategy_get_proba (strategy_t* t)
{
  return t->proba;
}

double
strategy_get_time (strategy_t* t)
{
  return t->time;
}
...
void
strategy_set_proba (strategy_t* t, double proba)
{
  t->proba = proba;
}
...
void
strategy_set_time (strategy_t* t, double time)
{
  t->time = time;
}
...
void
strategy_add_fm (strategy_t* t, fm_t* elem)
{
  tabular_fm_add_fm (t->tab_fm, elem);
}

void
strategy_add_fm_side (strategy_t* t, fm_t* elem, int side)
{
  tabular_fm_add_fm (t->tab_fm, elem);
  if (t->side == NULL)
    {
...
void
strategy_print_file (strategy_t* t, FILE* output_file)
{
