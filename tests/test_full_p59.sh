...
${CADO_NFS_SOURCE_DIR}/factor.sh 43341748620473677010074177283795146221310971425909898235183 -dlp -t 2 slaves.nrclients=$(((1+NCPUS)/2)) tasks.linalg.bwc.threads=$NCPUS && rm -rf $t
