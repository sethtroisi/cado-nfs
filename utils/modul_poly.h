...
int modul_poly_roots (residueul_t*, mpz_poly, modulusul_t);
int modul_poly_roots_ulong  (unsigned long*, mpz_poly, modulusul_t);
int modul_poly_cantor_zassenhaus (residueul_t*, modul_poly_t, modulusul_t);


void modul_poly_init (modul_poly_t, int);
int modul_poly_set_mod (modul_poly_t, mpz_poly, modulusul_t);
int modul_poly_set_mod_raw (modul_poly_t, mpz_poly, modulusul_t);
